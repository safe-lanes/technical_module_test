...
const ModifyPMS: React.FC = () => {
  ...
  const { currentUser, enterChangeRequestMode, exitChangeRequestMode } =
    useChangeRequest();
            ...
            <div className='p-6'>
              <div className='grid grid-cols-2 gap-6 mb-6'>
                ...
                <div>
                  ...
                  <span
                    className={`px-3 py-1 rounded-full text-xs font-medium ${getStatusColor(selectedRequest.status)}`}
                  >
