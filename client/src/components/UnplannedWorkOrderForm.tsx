                ...
                <div className='border border-gray-200 rounded-lg mb-6'>
                  <div className='bg-gray-50 px-6 py-4 border-b border-gray-200 flex items-center justify-between'>
                    ...
                    <p className='text-sm text-[#52baf3]'>
                      Enter details related to the unplanned new work order
                    </p>
                  </div>
                      ...
                      <div className='grid grid-cols-3 gap-6'>
                        ...
                        <div className='space-y-2'>
                          ...
                          <Input
                            ...
                            onChange={e =>
                              handleInputChange('workOrder', e.target.value)
                            }
                        ...
                        <div className='space-y-2'>
                          ...
                          >
                            ...
                            <SelectContent>
                              <SelectItem value='Unplanned Maintenance'>
                                Unplanned Maintenance
                              </SelectItem>
                              <SelectItem value='Emergency Maintenance'>
                                Emergency Maintenance
                              </SelectItem>
                              <SelectItem value='Breakdown Maintenance'>
                        ...
                        <div className='space-y-2'>
                          ...
                          >
                            ...
                            <SelectContent>
                              ...
                              <SelectItem value='2nd Engineer'>
                                2nd Engineer
                              </SelectItem>
                              <SelectItem value='3rd Engineer'>
                                3rd Engineer
                              </SelectItem>
                              <SelectItem value='4th Engineer'>
                                4th Engineer
                              </SelectItem>
                            </SelectContent>
                          </Select>
              ...
              {activeSection === 'partB' && (
                <div className='border border-gray-200 rounded-lg mb-6'>
                  <div className='bg-gray-50 px-6 py-4 border-b border-gray-200 flex items-center justify-between'>
                    ...
                    <p className='text-sm text-[#52baf3]'>
                      Enter work completion details here including Risk
                      assessment, checklists, comments etc.
                    </p>
                  </div>
      ...
      <Dialog open={isPermitDialogOpen} onOpenChange={setIsPermitDialogOpen}>
        <DialogContent className='max-w-md'>
          ...
          <div className='flex justify-end gap-2 pt-4'>
            <Button
              variant='outline'
              onClick={() => setIsPermitDialogOpen(false)}
            >
              Cancel
            </Button>
            <Button
