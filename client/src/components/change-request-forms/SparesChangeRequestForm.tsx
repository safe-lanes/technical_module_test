    ...
    <div className='w-[95%] max-w-7xl max-h-[90vh] overflow-auto bg-white rounded-lg shadow-lg'>
      ...
      <div className='p-6'>
        ...
        <div className='grid grid-cols-12 gap-3 bg-gray-50 p-3 rounded-t text-sm font-medium border border-[#52baf3]'>
          ...
          <div className={`col-span-3 ${getLabelStyle()}`}>
            Linked Component
          </div>
            ...
            >
              <div className='col-span-2'>
                <Input
                  value={item.partCode}
                  onChange={e =>
                    handleInputChange(index, 'partCode', e.target.value)
                  }
              ...
              <div className='col-span-2'>
                <Input
                  value={item.partName}
                  onChange={e =>
                    handleInputChange(index, 'partName', e.target.value)
                  }
              ...
              <div className='col-span-3'>
                <Select
                  ...
                  onValueChange={value =>
                    handleInputChange(index, 'linkedComponent', value)
                  }
                >
                  <SelectTrigger
              ...
              <Select
                value={item.critical}
                onValueChange={value =>
                  handleInputChange(index, 'critical', value)
                }
              >
