...
const AddFieldModal: React.FC<AddFieldModalProps> = ({
  ...
  const isValid = fieldData.label && fieldData.type && fieldData.key && !existingKeys.includes(fieldData.key);
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setFieldData(prev => ({
                      ...prev,
                      validation: { ...prev.validation, minDate: e.target.value }
                    }))}
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setFieldData(prev => ({
                      ...prev,
                      validation: { ...prev.validation, maxDate: e.target.value }
                    }))}
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setFieldData(prev => ({
                      ...prev,
                      validation: { ...prev.validation, regex: e.target.value }
                    }))}
          ...
          {isAdmin && (
            <div className="space-y-2">
              ...
              {existingKeys.includes(fieldData.key) && (
                <p className="text-sm text-red-500">This key already exists in the form</p>
              )}
            </div>
          )}
        </div>
