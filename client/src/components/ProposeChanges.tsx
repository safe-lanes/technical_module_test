          ...
          <div className='col-span-1'>
            <Switch
              ...
              onCheckedChange={checked =>
                handleToggleField('jobTitle', checked)
              }
              disabled={disabled}
            />
          </div>
        ...
        <div className='grid grid-cols-12 gap-4 items-center py-2 border-b'>
          ...
          <div className='col-span-1'>
            <Switch
              ...
              onCheckedChange={checked =>
                handleToggleField('frequencyType', checked)
              }
              disabled={disabled}
            />
          </div>
        ...
        <div className='grid grid-cols-12 gap-4 items-center py-2 border-b'>
          ...
          <div className='col-span-1'>
            <Switch
              ...
              onCheckedChange={checked =>
                handleToggleField('frequencyValue', checked)
              }
              disabled={disabled}
            />
          </div>
          <div className='col-span-4'>
            <div className='flex gap-2'>
              <Input
                ...
                onChange={e =>
                  handleFieldChange('frequencyValue', parseInt(e.target.value))
                }
              ...
              {(fieldValues['frequencyType'] || fields.frequencyType) ===
                ...
                <Select
                  ...
                  onValueChange={value =>
                    handleFieldChange('frequencyUnit', value)
                  }
                  disabled={!proposedFields['frequencyValue'] || disabled}
                >
        ...
        <div className='grid grid-cols-12 gap-4 items-center py-2 border-b'>
          ...
          <div className='col-span-1'>
            <Switch
              ...
              onCheckedChange={checked =>
                handleToggleField('critical', checked)
              }
              disabled={disabled}
            />
          </div>
          <div className='col-span-4'>
            <Select
              value={
                fieldValues['critical']?.toString() ||
                fields.critical?.toString() ||
                'false'
              }
              onValueChange={value =>
                handleFieldChange('critical', value === 'true')
              }
        ...
        <div className='grid grid-cols-12 gap-4 items-center py-2 border-b'>
          ...
          <div className='col-span-1'>
            <Switch
              ...
              onCheckedChange={checked =>
                handleToggleField('assignedTo', checked)
              }
              disabled={disabled}
            />
          </div>
        ...
        <div className='grid grid-cols-12 gap-4 items-start py-2 border-b'>
          ...
          <div className='col-span-1'>
            <Switch
              ...
              onCheckedChange={checked =>
                handleToggleField('instructions', checked)
              }
              disabled={disabled}
            />
          </div>
        ...
        <div className='grid grid-cols-12 gap-4 items-center py-2 border-b'>
          ...
          <div className='col-span-1'>
            <Switch
              ...
              onCheckedChange={checked =>
                handleToggleField('serialNo', checked)
              }
              disabled={disabled}
            />
          </div>
        ...
        <div className='grid grid-cols-12 gap-4 items-center py-2 border-b'>
          ...
          <div className='col-span-1'>
            <Switch
              ...
              onCheckedChange={checked =>
                handleToggleField('deptCategory', checked)
              }
              disabled={disabled}
            />
          </div>
        ...
        <div className='grid grid-cols-12 gap-4 items-center py-2 border-b'>
          ...
          <div className='col-span-1'>
            <Switch
              ...
              onCheckedChange={checked =>
                handleToggleField('location', checked)
              }
              disabled={disabled}
            />
          </div>
        ...
        <div className='grid grid-cols-12 gap-4 items-center py-2 border-b'>
          ...
          <div className='col-span-1'>
            <Switch
              ...
              onCheckedChange={checked =>
                handleToggleField('commissionedDate', checked)
              }
              disabled={disabled}
            />
          </div>
            ...
            <Popover>
              ...
              <PopoverContent className='w-auto p-0'>
                <Calendar
                  ...
                  onSelect={date =>
                    handleFieldChange('commissionedDate', date?.toISOString())
                  }
                />
              </PopoverContent>
            </Popover>
        ...
        <div className='grid grid-cols-12 gap-4 items-center py-2 border-b'>
          ...
          <div className='col-span-1'>
            <Switch
              ...
              onCheckedChange={checked =>
                handleToggleField('classItem', checked)
              }
              disabled={disabled}
            />
          </div>
          <div className='col-span-4'>
            <Select
              value={
                fieldValues['classItem']?.toString() ||
                fields.classItem?.toString() ||
                'false'
              }
              onValueChange={value =>
                handleFieldChange('classItem', value === 'true')
              }
        ...
        <div className='grid grid-cols-12 gap-4 items-center py-2 border-b'>
          ...
          <div className='col-span-1'>
            <Switch
              ...
              onCheckedChange={checked =>
                handleToggleField('itemName', checked)
              }
              disabled={disabled}
            />
          </div>
        ...
        <CardContent>
          ...
          <div className='flex justify-between mt-6'>
            ...
            <Button
              ...
              disabled={
                disabled ||
                Object.keys(proposedFields).filter(k => proposedFields[k])
                  .length === 0
              }
            >
              Review Changes
          ...
          {pendingChanges.length > 0 && (
            <div className='space-y-4'>
              ...
              {targetType === 'work_order' &&
                pendingChanges.some(c => c.path.includes('frequency')) && (
