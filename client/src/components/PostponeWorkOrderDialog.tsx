        ...
        <div className='space-y-4 py-4'>
              ...
              <div className='flex items-center space-x-2 mt-6'>
                <Checkbox
                  ...
                  onCheckedChange={checked =>
                    setFormData({
                      ...formData,
                      informOfficer: checked as boolean,
                    })
                  }
                />
          ...
          <div className='grid grid-cols-2 gap-6'>
            <div className='space-y-2'>
              ...
              <Input
                ...
                onChange={e =>
                  setFormData({ ...formData, originalDueDate: e.target.value })
                }
                className='bg-gray-50'
                readOnly
              />
          ...
          <div className='space-y-2'>
            ...
            <Textarea
              ...
              onChange={e =>
                setFormData({
                  ...formData,
                  reasonForPostponement: e.target.value,
                })
              }
          ...
          <div className='space-y-2'>
            ...
            <Textarea
              ...
              onChange={e =>
                setFormData({ ...formData, approvalRemarks: e.target.value })
              }
          ...
          <div className='grid grid-cols-2 gap-6'>
            ...
            <div className='space-y-2'>
              ...
              <Select
                ...
                onValueChange={value =>
                  setFormData({ ...formData, durationOfPostponement: value })
                }
              >
                <SelectTrigger>
                  <SelectValue />
            ...
            <div className='flex items-center space-x-2'>
              <Checkbox
                ...
                onCheckedChange={checked =>
                  setFormData({
                    ...formData,
                    attachDocument: checked as boolean,
                  })
                }
              />
