...
var WorkOrders = function () {
  ...
  var _b = useState(''),
    selectedVessel = _b[0],
    setSelectedVessel = _b[1];
  var _c = useState(''),
    selectedPeriod = _c[0],
    setSelectedPeriod = _c[1];
  var _d = useState(''),
    selectedRank = _d[0],
    setSelectedRank = _d[1];
  var _e = useState(''),
    selectedComponent = _e[0],
    setSelectedComponent = _e[1];
  var _f = useState(''),
    selectedCriticality = _f[0],
    setSelectedCriticality = _f[1];
  var _g = useState('All W.O'),
    activeTab = _g[0],
    setActiveTab = _g[1];
  var _h = useState(false),
    postponeDialogOpen = _h[0],
    setPostponeDialogOpen = _h[1];
  var _j = useState(false),
    workOrderFormOpen = _j[0],
    setWorkOrderFormOpen = _j[1];
  var _k = useState(false),
    unplannedWorkOrderFormOpen = _k[0],
    setUnplannedWorkOrderFormOpen = _k[1];
  var _l = useState(null),
    selectedWorkOrder = _l[0],
    setSelectedWorkOrder = _l[1];
  // Modify mode integration
  var _m = useModifyMode(),
    isModifyMode = _m.isModifyMode,
    targetId = _m.targetId,
    fieldChanges = _m.fieldChanges;
  ...
  var _o = useState(backfilledWorkOrders),
    workOrdersList = _o[0],
    setWorkOrdersList = _o[1];
  ...
  useEffect(
    function () {
      ...
      if (
        ...
        var targetWorkOrder = workOrdersList.find(function (wo) {
          return wo.id === previewTargetId;
        });
        if (targetWorkOrder) {
  ...
  var handleWorkOrderSubmit = function (workOrderId, formData) {
    if (
      (formData === null || formData === void 0 ? void 0 : formData.type) ===
      'execution'
    ) {
      ...
      var existingExecutions = workOrdersList.filter(function (wo) {
        ...
        return (
          ...
          ((_a = wo.executionId) === null || _a === void 0
            ? void 0
            : _a.startsWith(''.concat(year_1, '-').concat(templateCode_1)))
        );
      });
      var sequence = String(existingExecutions.length + 1).padStart(2, '0');
      var executionId = ''
        .concat(year_1, '-')
        .concat(templateCode_1, '-')
        .concat(sequence);
      ...
      setWorkOrdersList(function (prev) {
        return prev.map(function (wo) {
          return wo.id === workOrderId
            ? __assign(__assign(__assign({}, wo), formData.data), {
                templateCode:
  ...
  var tabs = [
    ...
    },
    {
      ...
      count: workOrdersList.filter(function (wo) {
        return wo.isExecution && wo.status === 'Pending Approval';
      }).length,
    },
    {
      id: 'Overdue',
      label: 'Overdue',
      count: workOrdersList.filter(function (wo) {
        return !wo.isExecution && wo.status === 'Overdue';
      }).length,
    },
    {
      id: 'Completed',
    ...
    setWorkOrdersList(function (prev) {
      return prev.map(function (wo) {
        if (wo.executionId === workOrderId || wo.id === workOrderId) {
          ...
          var updatedWO = __assign(__assign({}, wo), {
            status: 'Approved',
    ...
    <div className='flex flex-col h-full'>
        ...
        <div className='flex items-center justify-between p-4'>
          ...
          <div className='flex gap-2'>
            ...
            <Button
              ...
              onClick={function () {
                return setUnplannedWorkOrderFormOpen(true);
              }}
            >
              <Plus className='h-4 w-4 mr-1' />
              Unplanned W.O
          ...
          {tabs.map(function (tab) {
            return (
              <button
                ...
                className={'px-3 py-1.5 rounded text-sm font-medium transition-colors '.concat(
                  activeTab === tab.id
      ...
      <div className='flex-1 overflow-auto bg-white'>
        <table className='w-full text-sm'>
          ...
          <tbody>
            {filteredWorkOrders.map(function (workOrder, index) {
              return (
                <tr
                  key={workOrder.id}
                  className={''.concat(
                  ...
                  onClick={function () {
                    return handleWorkOrderClick(workOrder);
                  }}
                >
      ...
      <PostponeWorkOrderDialog
        ...
        onClose={function () {
          return setPostponeDialogOpen(false);
        }}
      ...
      <WorkOrderForm
        ...
        onClose={function () {
          return setWorkOrderFormOpen(false);
        }}
        ...
        isApprovalMode={
          activeTab === 'Pending Approval' &&
          (selectedWorkOrder === null || selectedWorkOrder === void 0
            ? void 0
      ...
      <UnplannedWorkOrderForm
        ...
        onClose={function () {
          return setUnplannedWorkOrderFormOpen(false);
        }}
      />
