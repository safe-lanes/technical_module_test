...
export default function ModifyPMS() {
  ...
  var _h = useState(null),
    editingRequest = _h[0],
    setEditingRequest = _h[1];
  var _j = useState(null),
    viewingRequest = _j[0],
    setViewingRequest = _j[1];
  var _k = useState(false),
    showTargetPicker = _k[0],
    setShowTargetPicker = _k[1];
  var _l = useState(false),
    showSnapshotDialog = _l[0],
    setShowSnapshotDialog = _l[1];
  var _m = useState(null),
    snapshotToView = _m[0],
    setSnapshotToView = _m[1];
  var _o = useState(false),
    isNewRequestModalOpen = _o[0],
    setIsNewRequestModalOpen = _o[1];
  ...
  var _q = useQuery({
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                ...
                return [
                  4 /*yield*/,
                  fetch('/api/change-requests?'.concat(params)),
                ];
              case 1:
                response = _a.sent();
    ...
    _r = _q.data,
    requests = _r === void 0 ? [] : _r,
    isLoading = _q.isLoading;
  // Create mutation
          ...
          switch (_a.label) {
            case 0:
              return [
                ...
                apiRequest(
                  'PATCH',
                  '/api/change-requests/'.concat(id, '/status'),
                  {
                    status: 'submitted',
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                apiRequest('DELETE', '/api/change-requests/'.concat(id)),
              ];
            case 1:
              res = _a.sent();
              return [2 /*return*/, res.json()];
  ...
  useEffect(
    function () {
      var returnWithTarget = sessionStorage.getItem(
        'modifyPMS_returnWithTarget'
      );
      ...
      if (returnWithTarget === 'true' && formDataStr) {
        ...
        if (editingId && requests) {
          var requestToEdit = requests.find(function (r) {
            return r.id === parseInt(editingId);
          });
          if (requestToEdit) {
  ...
  var handleTargetSelect = function (targetType, targetId, payload) {
    return __awaiter(_this, void 0, void 0, function () {
        ...
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              ...
              apiRequest(
                'PUT',
                '/api/change-requests/'.concat(editingRequest.id),
                {
                  targetType: actualTargetType,
                  targetId: actualTargetId,
                  snapshotBeforeJson: snapshot,
  ...
  var getTargetDisplayName = function (request) {
    ...
    return ''
      .concat(snapshot.displayKey || '', ' - ')
      .concat(snapshot.displayName || '');
  };
  var handleView = function (request) {
    return __awaiter(_this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              fetch('/api/change-requests/'.concat(request.id)),
            ];
          case 1:
            response = _a.sent();
  ...
  var getStatusBadge = function (status) {
    ...
    return (
      <Badge className={''.concat(statusColors[status], ' text-white')}>
  ...
  return (
    <>
          ...
          <div className='p-4'>
            ...
            <div className='bg-white rounded-b-lg'>
              <div className='p-4 space-y-1'>
                <button
                  onClick={function () {
                    return setCategoryFilter('components');
                  }}
                  className={'w-full text-left px-3 py-2 text-sm rounded transition-colors '.concat(
                ...
                <button
                  onClick={function () {
                    return setCategoryFilter('work_orders');
                  }}
                  className={'w-full text-left px-3 py-2 text-sm rounded transition-colors '.concat(
                ...
                <button
                  onClick={function () {
                    return setCategoryFilter('spares');
                  }}
                  className={'w-full text-left px-3 py-2 text-sm rounded transition-colors '.concat(
                ...
                <button
                  onClick={function () {
                    return setCategoryFilter('stores');
                  }}
                  className={'w-full text-left px-3 py-2 text-sm rounded transition-colors '.concat(
          ...
          <div className='bg-white p-6 border-b border-gray-200'>
            ...
            <div className='flex justify-between items-center'>
              ...
              <Button
                ...
                onClick={function () {
                  return setIsNewRequestModalOpen(true);
                }}
              >
              ...
              {isLoading ? (
                ...
                <div className='h-full flex flex-col'>
                  ...
                  <div className='mt-auto px-6 py-4 border-t border-gray-200 text-sm text-gray-500'>
                    {requests.length > 0
                      ? '0 to '
                          .concat(requests.length, ' of ')
                          .concat(requests.length)
                      : '0 to 0 of 0'}
                  </div>
                </div>
              )}
      ...
      {/* Create/Edit Dialog */}
      <Dialog
        open={showCreateDialog || !!editingRequest}
        ...
        <DialogContent className='max-w-2xl'>
          ...
          <div className='space-y-4'>
            <div>
              ...
              <Input
                ...
                onChange={function (e) {
                  return setFormData(
                    __assign(__assign({}, formData), { title: e.target.value })
                  );
                }}
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={function (value) {
                  return setFormData(
                    __assign(__assign({}, formData), { category: value })
                  );
                }}
              >
            ...
            <div>
              ...
              <Textarea
                ...
                onChange={function (e) {
                  return setFormData(
                    __assign(__assign({}, formData), { reason: e.target.value })
                  );
                }}
                    ...
                    <div className='flex items-center gap-2'>
                      ...
                      <div>
                        ...
                        <p className='text-sm text-gray-600'>
                          Target Type:{' '}
                          {(_a = formData.targetType) === null || _a === void 0
                            ? void 0
                            : _a.replace('_', ' ').toUpperCase()}
                        </p>
                      </div>
                    </div>
                    <Button
            ...
            {(editingRequest === null || editingRequest === void 0
              ? void 0
              ...
              (!editingRequest ||
                ...
                <div className='mt-6'>
                  <ProposeChanges
                    ...
                    onSaveProposed={function (changes, movePreview) {
                      setFormData(function (prev) {
                        return __assign(__assign({}, prev), {
          ...
          <DialogFooter>
            ...
            {editingRequest &&
              ...
              formData.proposedChangesJson.length > 0 && (
                <Button
                  variant='default'
                  onClick={function () {
                    handleSave();
                        ...
                        <div className='flex items-start gap-3'>
                          ...
                          <div className='flex-1'>
                            ...
                            <p className='text-sm text-gray-600 mb-2'>
                              Type:{' '}
                              {(_b = viewingRequest.targetType) === null ||
                              _b === void 0
                                ? void 0
                                : _b.replace('_', ' ').toUpperCase()}
                            </p>
                            ...
                            <div className='mt-3 grid grid-cols-2 gap-2 text-sm'>
                              {Object.entries(
                                viewingRequest.snapshotBeforeJson.fields || {}
                              ).map(function (_a) {
                                var key = _a[0],
                                  value = _a[1];
                                return (
              ...
              <TabsContent value='comments'>
                <div className='space-y-4'>
                  ...
                  viewingRequest.comments.length > 0 ? (
                    viewingRequest.comments.map(function (comment) {
                      return (
                        <Card key={comment.id}>
                          <CardContent className='pt-4'>
              ...
              <TabsContent value='attachments'>
                <div className='space-y-2'>
                  ...
                  viewingRequest.attachments.length > 0 ? (
                    viewingRequest.attachments.map(function (attachment) {
                      return (
      ...
      <ChangeRequestModal
        ...
        onClose={function () {
          return setIsNewRequestModalOpen(false);
        }}
      />
    </>
  );
