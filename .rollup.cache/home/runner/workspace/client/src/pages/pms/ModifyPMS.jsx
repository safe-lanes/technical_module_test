      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="flex-1 p-6">
          <div className="bg-white rounded-lg border border-gray-200 h-full">
            {isLoading ? (<div className="text-center py-12 text-gray-500">Loading...</div>) : requests.length === 0 ? (<div className="text-center py-12 text-gray-500">
                ...
                <div className="mt-auto px-6 py-4 border-t border-gray-200 text-sm text-gray-500">
                  {requests.length > 0 ? "0 to ".concat(requests.length, " of ").concat(requests.length) : '0 to 0 of 0'}
                </div>
              </div>)}
          </div>
        </div>
        ...
        <DialogContent className="max-w-2xl">
          ...
          <div className="space-y-4">
            <div>
              ...
              <Input id="title" value={formData.title} onChange={function (e) { return setFormData(__assign(__assign({}, formData), { title: e.target.value })); }} placeholder="Brief description of the change (max 120 characters)" maxLength={120}/>
            ...
            <div>
              ...
              <Textarea id="reason" value={formData.reason} onChange={function (e) { return setFormData(__assign(__assign({}, formData), { reason: e.target.value })); }} placeholder="Detailed explanation of why this change is needed..." rows={6}/>
            </div>
            ...
            <div>
              ...
              <div className="border rounded-lg p-4 bg-gray-50">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          Target Type: {(_a = formData.targetType) === null || _a === void 0 ? void 0 : _a.replace('_', ' ').toUpperCase()}
                        </p>
                      </div>
                    </div>
                ...
                setLocation(routes[formData.category] || "/pms/components?".concat(params));
            }}>
                      Change Target
                    </Button>
            ...
            (!editingRequest || editingRequest.status === 'draft' || editingRequest.status === 'returned') && (<div className="mt-6">
          ...
          <DialogFooter>
            ...
            <Button onClick={handleSave} disabled={!formData.title || createMutation.isPending || updateMutation.isPending}>
            ...
            formData.proposedChangesJson && formData.proposedChangesJson.length > 0 && (<Button variant="default" onClick={function () {
                handleSave();
                // After saving, submit
                setTimeout(function () {
                    if (editingRequest) {
        ...
        <DialogContent className="max-w-3xl max-h-[80vh] overflow-y-auto">
          ...
          {viewingRequest && (<Tabs defaultValue="details">
              ...
              <TabsContent value="details" className="space-y-4">
                ...
                <div>
                  <Label>Target</Label>
                  {viewingRequest.targetType && viewingRequest.snapshotBeforeJson ? (<Card className="mt-2">
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-sm text-gray-600 mb-2">
                              Type: {(_b = viewingRequest.targetType) === null || _b === void 0 ? void 0 : _b.replace('_', ' ').toUpperCase()}
                            </p>
              ...
              <TabsContent value="snapshot">
                <div className="space-y-4">
                  {viewingRequest.snapshotBeforeJson ? (<Card>
                    ...
                    </Card>) : (<p className="text-center text-gray-500 py-4">No snapshot available</p>)}
                </div>
              </TabsContent>

              <TabsContent value="comments">
                <div className="space-y-4">
                  {viewingRequest.comments && viewingRequest.comments.length > 0 ? (viewingRequest.comments.map(function (comment) { return (<Card key={comment.id}>
                        <CardContent className="pt-4">
                      ...
                      </Card>); })) : (<p className="text-center text-gray-500 py-4">No comments yet</p>)}
                </div>
              </TabsContent>

              <TabsContent value="attachments">
                <div className="space-y-2">
                  {viewingRequest.attachments && viewingRequest.attachments.length > 0 ? (viewingRequest.attachments.map(function (attachment) { return (<Card key={attachment.id}>
                        <CardContent className="pt-4">
                          <div className="flex justify-between items-center">
                      ...
                      </Card>); })) : (<p className="text-center text-gray-500 py-4">No attachments</p>)}
                </div>
              </TabsContent>
            </Tabs>)}
