...
export default function BulkImport() {
  ...
  var _e = useState(false),
    archiveMissing = _e[0],
    setArchiveMissing = _e[1];
  var _f = useState(null),
    dryRunResult = _f[0],
    setDryRunResult = _f[1];
            ...
            switch (_a.label) {
              case 0:
                ...
                return [
                  4 /*yield*/,
                  fetch(
                    '/api/bulk/history?type='.concat(selectedTemplate.type)
                  ),
                ];
              case 1:
                response = _a.sent();
  ...
  var handleDownloadTemplate = function () {
    return __awaiter(_this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            if (!selectedTemplate) return [2 /*return*/];
            _a.label = 1;
          case 1:
            _a.trys.push([1, 4, , 5]);
            return [
              4 /*yield*/,
              fetch('/api/bulk/template?type='.concat(selectedTemplate.type)),
            ];
          case 2:
            response = _a.sent();
  ...
  // Handle file drop
  var handleFileDrop = useCallback(
    function (e) {
      e.preventDefault();
  ...
  // Dry run validation
  var handleDryRun = function (file) {
    return __awaiter(_this, void 0, void 0, function () {
            ...
            if (result.summary.errors > 0) {
              toast({
                ...
                description: 'Found '.concat(
                  ...
                  ' error(s). Please fix them before importing.'
                ),
                variant: 'destructive',
              });
              ...
              toast({
                title: 'Validation Complete',
                description: 'File is valid with '.concat(
  ...
  var handleImport = function () {
    return __awaiter(_this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            if (!dryRunResult || !selectedTemplate) return [2 /*return*/];
            setIsImporting(true);
            _a.label = 1;
          case 1:
            ...
            return [
              4 /*yield*/,
              apiRequest('POST', '/api/bulk/import', {
          ...
          case 3:
            ...
            toast({
              ...
              description: 'Created: '
                .concat(result.created, ', Updated: ')
                .concat(result.updated, ', Skipped: ')
                .concat(result.skipped)
                .concat(
                  result.archived ? ', Archived: '.concat(result.archived) : ''
                ),
            });
  ...
  var handleDownloadHistoryFile = function (historyId, fileType) {
    return __awaiter(_this, void 0, void 0, function () {
        ...
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              fetch(
                '/api/bulk/history/'.concat(historyId, '/').concat(fileType)
              ),
            ];
          case 1:
            response = _a.sent();
      ...
      <div className='mb-6'>
        ...
        <div className='mt-4 flex gap-2'>
          <Button
            ...
            onClick={function () {
              return setActiveTab('bulk-import');
            }}
          >
            Bulk Data Imp
          </Button>
                ...
                {templates.map(function (template, index) {
                  return (
                    <button
                      ...
                      className={'w-full text-left px-3 py-2 rounded-md transition-colors '.concat(
              ...
              <Card className='p-6'>
                ...
                <div className='flex justify-between items-center mb-6'>
                  <h2 className='text-xl font-semibold'>
                    {templates.findIndex(function (t) {
                    ...
                    <div>
                      <Label className='flex items-center gap-2'>
                        <input
                          ...
                          onChange={function (e) {
                            return setArchiveMissing(e.target.checked);
                          }}
                          className='rounded'
                        />
                  ...
                  <div className='mb-6'>
                    ...
                    <div className='border rounded-lg overflow-hidden mb-4'>
                      <Table>
                        ...
                        <TableBody>
                          {dryRunResult.rows.slice(0, 20).map(function (row) {
                            return (
                                  ...
                                  <TableCell>
                                    <div className='flex gap-2'>
                                      <Button
                                        ...
                                        variant='ghost'
                                        onClick={function () {
                                          return handleDownloadHistoryFile(
                                            item.id,
                                            'file'
                                          );
                                        }}
