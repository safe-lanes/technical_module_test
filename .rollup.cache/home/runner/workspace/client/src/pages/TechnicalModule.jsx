    ...
    return (<div className="min-h-screen bg-gray-50">
      ...
      <div className="flex">
        ...
        <div className="flex-1">
          {selectedSubModule === "pms" && selectedMenuItem === "components" ? (<Components />) : selectedSubModule === "pms" && selectedMenuItem === "work-orders" ? (<WorkOrders />) : selectedSubModule === "pms" && selectedMenuItem === "running-hrs" ? (<RunningHours />) : selectedSubModule === "pms" && selectedMenuItem === "spares" ? (<Spares />) : selectedSubModule === "pms" && selectedMenuItem === "stores" ? (<Stores />) : selectedSubModule === "pms" && selectedMenuItem === "modify-pms" ? (<ModifyPMS />) : selectedSubModule === "pms" && selectedMenuItem === "admin" ? (<AdminPanel />) : selectedSubModule === "admin" && selectedMenuItem === "alerts" ? (<Alerts />) : (<div className="p-6">
