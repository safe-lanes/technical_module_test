...
import { Search, ChevronRight, ChevronDown, Edit, Trash2, Plus, FileSpreadsheet, X, MessageSquare, Calendar } from "lucide-react";
      ...
      <div className="mb-4">
        ...
        <div className="flex justify-between items-center mb-4">
          ...
          <div className="flex gap-2">
            <Button className="bg-[#52baf3] hover:bg-[#40a8e0] text-white" onClick={function () { return setIsAddSpareModalOpen(true); }}>+ Add Spare</Button>
          ...
          <div className="w-[70%]">
            ...
            <div className="bg-white rounded-lg shadow-sm border">
              ...
              <div className="divide-y divide-gray-200">
                ...
                var stockStatus = getStockStatus(spare.rob, spare.min);
                var isCritical = spare.critical === "Critical" || spare.critical === "Yes";
                return (<div key={spare.id} className="px-4 py-3">
                      <div className="grid grid-cols-9 gap-4 text-sm items-center">
                        ...
                        <div>
                          {isCritical && (<span className="bg-red-100 text-red-800 px-2 py-1 rounded text-xs">
                              Critical
                            </span>)}
                        </div>
                        ...
                        <div>
                          {stockStatus === "Low" && (<span className="bg-yellow-100 text-yellow-800 px-2 py-1 rounded text-xs">
                              Low
                            </span>)}
                          {stockStatus === "OK" && (<span className="bg-green-100 text-green-800 px-2 py-1 rounded text-xs">
                              OK
                            </span>)}
                        </div>
            ...
            <div className="p-6">
              ...
              <div className="border border-t-0 rounded-b max-h-[400px] overflow-y-auto">
                ...
                return (<div key={spare.id} className="grid grid-cols-8 gap-3 p-3 border-b bg-white items-center">
                      ...
                      <div>
                        <Input type="number" min="0" className="text-sm h-8" placeholder="0" value={consumed || ''} onChange={function (e) { return handleBulkUpdateChange(spare.id, 'consumed', e.target.value); }}/>
                      </div>
                      <div>
                        <Input type="number" min="0" className="text-sm h-8" placeholder="0" value={received || ''} onChange={function (e) { return handleBulkUpdateChange(spare.id, 'received', e.target.value); }}/>
                      </div>
