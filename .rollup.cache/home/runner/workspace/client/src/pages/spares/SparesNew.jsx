...
var Spares = function () {
  ...
  var _f = useState(''),
    stockFilter = _f[0],
    setStockFilter = _f[1];
  var _g = useState('V001'),
    vesselId = _g[0],
    setVesselId = _g[1];
  // Dialog states
  var _h = useState(false),
    isAddSpareModalOpen = _h[0],
    setIsAddSpareModalOpen = _h[1];
  var _j = useState(false),
    isBulkUpdateModalOpen = _j[0],
    setIsBulkUpdateModalOpen = _j[1];
  var _k = useState(false),
    isConsumeModalOpen = _k[0],
    setIsConsumeModalOpen = _k[1];
  var _l = useState(false),
    isReceiveModalOpen = _l[0],
    setIsReceiveModalOpen = _l[1];
  var _m = useState(null),
    selectedSpare = _m[0],
    setSelectedSpare = _m[1];
  // Form states
  var _o = useState({ quantity: '', date: '', workOrder: '', remarks: '' }),
    consumeForm = _o[0],
    setConsumeForm = _o[1];
  var _p = useState({ quantity: '', date: '', supplier: '', remarks: '' }),
    receiveForm = _p[0],
    setReceiveForm = _p[1];
  var _q = useState({}),
    bulkUpdateData = _q[0],
    setBulkUpdateData = _q[1];
  var _r = useState({
      partCode: '',
      partName: '',
      componentId: '',
      ...
      queryFn: function () {
        return __awaiter(void 0, void 0, void 0, function () {
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                return [4 /*yield*/, fetch('/api/spares/'.concat(vesselId))];
              case 1:
                response = _a.sent();
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                return [
                  4 /*yield*/,
                  fetch('/api/spares/history/'.concat(vesselId)),
                ];
              case 1:
                response = _a.sent();
        ...
        return __generator(this, function (_b) {
          switch (_b.label) {
            case 0:
              return [
                4 /*yield*/,
                fetch('/api/spares/'.concat(id, '/consume'), {
                  method: 'POST',
                  headers: {
        ...
        return __generator(this, function (_b) {
          switch (_b.label) {
            case 0:
              return [
                4 /*yield*/,
                fetch('/api/spares/'.concat(id, '/receive'), {
                  method: 'POST',
                  headers: {
                    'Content-Type': 'application/json',
                  },
  ...
  var bulkUpdateMutation = useMutation({
    ...
    onSuccess: function (results) {
      ...
      queryClient.setQueryData(['/api/spares', vesselId], function (old) {
        ...
        return old.map(function (spare) {
          var result = results.find(function (r) {
            return r.componentSpareId === spare.id && r.success;
          });
      ...
      toast({
        ...
        description: 'Updated: '
          .concat(succeeded, ', Skipped: ')
          .concat(skipped, ', Failed: ')
          .concat(failed),
      });
  ...
  var filteredSpares = useMemo(
    function () {
      ...
      if (searchTerm) {
        ...
        filtered = filtered.filter(function (spare) {
          ...
          return (
            ...
            ((_a = spare.componentCode) === null || _a === void 0
              ? void 0
              : _a.toLowerCase().includes(search_1)) ||
            ((_b = spare.location) === null || _b === void 0
              ? void 0
              : _b.toLowerCase().includes(search_1))
          );
        });
      }
      ...
      if (stockFilter && stockFilter !== 'All') {
        filtered = filtered.filter(function (spare) {
          return spare.stockStatus === stockFilter;
        });
      }
      return filtered;
    },
  ...
  var saveBulkUpdates = function () {
    ...
    var hasErrors = Object.entries(bulkUpdateData).some(function (_a) {
      var id = _a[0],
        data = _a[1];
      var spare = sparesData.find(function (s) {
            ...
            <>
              ...
              <div className='overflow-y-auto h-[calc(100%-48px)]'>
                {historyData.length === 0 ? (
                  ...
                  historyData.map(function (history) {
                    return (
                      <div
                        key={history.id}
                        className='px-4 py-3 border-b border-gray-100 hover:bg-gray-50'
                      >
                        <div className='grid grid-cols-9 gap-4 text-sm items-center'>
                          ...
                          <div
                            className={'text-center font-semibold '.concat(
                              history.qtyChange < 0
                                ? 'text-red-600'
                                : 'text-green-600'
                            )}
        ...
        <DialogContent>
          ...
          <div className='space-y-4'>
            <div>
              <Label>
                Part:{' '}
                {selectedSpare === null || selectedSpare === void 0
                  ? void 0
                  : selectedSpare.partCode}{' '}
                -{' '}
                {selectedSpare === null || selectedSpare === void 0
                  ? void 0
                  : selectedSpare.partName}
              </Label>
            ...
            <div>
              ...
              <Input
                ...
                onChange={function (e) {
                  return setConsumeForm(
                    __assign(__assign({}, consumeForm), {
          ...
          <DialogFooter>
            <Button
              variant='outline'
              onClick={function () {
                return setIsConsumeModalOpen(false);
              }}
            >
              Cancel
            </Button>
                  ...
                  onChange={function (e) {
                    ...
                    setBulkUpdateData(function (prev) {
                      ...
                      Object.keys(updated).forEach(function (id) {
                        updated[Number(id)] = __assign(
                          __assign({}, updated[Number(id)]),
                          { receivedDate: date }
                        );
                      });
                      return updated;
              ...
              <table className='w-full'>
                ...
                <tbody>
                  {filteredSpares.map(function (spare) {
                    ...
                    var needsReceivedDate =
                      received > 0 &&
                      !((_c = bulkUpdateData[spare.id]) === null ||
                      _c === void 0
                        ? void 0
                        : _c.receivedDate);
                      ...
                      >
                        ...
                        <td className='px-4 py-2'>
                          <Input
                            ...
                            max={spare.rob}
                            value={
                              ((_d = bulkUpdateData[spare.id]) === null ||
                              _d === void 0
                                ? void 0
                                : _d.consumed) || ''
                            }
                            ...
                            className={'w-20 mx-auto '.concat(
                              hasInsufficientStock ? 'border-red-500' : ''
                            )}
                          />
                        </td>
                        <td className='px-4 py-2'>
                          <Input
                            ...
                            min='0'
                            value={
                              ((_e = bulkUpdateData[spare.id]) === null ||
                              _e === void 0
                                ? void 0
                                : _e.received) || ''
                            }
                        ...
                        <td className='px-4 py-2 text-center'>
                          <div
                            className={'text-sm font-medium '.concat(
                              hasInsufficientStock ? 'text-red-600' : ''
                            )}
                          >
                            {newROB}
              ...
              disabled={
                ...
                (function () {
                  ...
                  return Object.entries(bulkUpdateData).some(function (_a) {
                    var id = _a[0],
                      data = _a[1];
                    var spare = filteredSpares.find(function (s) {
                      return s.id === parseInt(id);
                    });
                    if (!spare) return false;
                    var newROB =
            ...
            <div className='grid grid-cols-2 gap-4'>
              <div>
                ...
                <Input
                  ...
                  onChange={function (e) {
                    return setAddSpareForm(
                      __assign(__assign({}, addSpareForm), {
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={function (value) {
                  return setAddSpareForm(
                    __assign(__assign({}, addSpareForm), { componentId: value })
                  );
                }}
              >
              ...
              {addSpareForm.componentId &&
                (function () {
                  ...
                  var component = findComponent(componentTree);
                  var spareCode = component
                    ? 'SP-'.concat(component.code, '-XXX')
                    : '';
                  return spareCode ? (
            ...
            <div className='grid grid-cols-3 gap-4'>
              <div>
                ...
                <Select
                  ...
                  onValueChange={function (value) {
                    return setAddSpareForm(
                      __assign(__assign({}, addSpareForm), { critical: value })
                    );
                  }}
                >
