...
var ModifyPMS = function () {
    ...
    var filteredRequests = requests.filter(function (request) {
        ...
        var matchesSearch = !searchStatus ||
      ...
      <div className='flex gap-6'>
        ...
        <div className='w-64'>
          <div className='bg-white rounded-lg shadow-sm'>
            ...
            <div className='p-0'>
              {categories.map(function (category) { return (<div key={category.id} className={"px-4 py-3 border-b border-gray-200 cursor-pointer hover:bg-gray-50 ".concat(selectedCategory === category.name
                ? 'bg-blue-50 border-l-4 border-l-[#52baf3]'
                : '')} onClick={function () {
                return setSelectedCategory(selectedCategory === category.name ? null : category.name);
            }}>
      ...
      {isReviewMode && selectedRequest && (<div className='fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50'>
          <div className='bg-white rounded-lg shadow-lg w-[90%] max-w-4xl max-h-[90vh] overflow-auto'>
            ...
            <div className='p-6'>
              ...
              {currentUser.role === 'approver' &&
                selectedRequest.status === 'Pending Approval' && (<div className='mb-6'>
