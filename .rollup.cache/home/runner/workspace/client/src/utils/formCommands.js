...
var FormCommands = /** @class */ (function () {
  ...
  FormCommands.createFormEditor = function (formName) {
    try {
      ...
      console.log(
        '\u2705 Form Editor created successfully for: '.concat(formName)
      );
      console.log(
      ...
      console.error(
        '\u274C Error creating Form Editor for '.concat(formName, ':'),
        error
      );
    }
  };
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            if (!response.ok) {
              throw new Error(
                'Failed to create form: '.concat(response.statusText)
              );
            }
            console.log(
              '\u2705 Form "'.concat(formName, '" created in database')
            );
