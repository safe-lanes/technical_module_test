...
export function extractContextFromWorkOrder(workOrder, executionData) {
    var _a, _b;
    return {
        jobTitle: (workOrder === null || workOrder === void 0 ? void 0 : workOrder.job_title) || (workOrder === null || workOrder === void 0 ? void 0 : workOrder.jobTitle),
        component: (workOrder === null || workOrder === void 0 ? void 0 : workOrder.component_name) || (workOrder === null || workOrder === void 0 ? void 0 : workOrder.componentName),
        componentCategory: (workOrder === null || workOrder === void 0 ? void 0 : workOrder.component_category) || (workOrder === null || workOrder === void 0 ? void 0 : workOrder.componentCategory),
        maintenanceType: (workOrder === null || workOrder === void 0 ? void 0 : workOrder.maintenance_basis) || (workOrder === null || workOrder === void 0 ? void 0 : workOrder.maintenanceBasis),
        frequency: ((_a = workOrder === null || workOrder === void 0 ? void 0 : workOrder.frequency_value) === null || _a === void 0 ? void 0 : _a.toString()) || ((_b = workOrder === null || workOrder === void 0 ? void 0 : workOrder.frequencyValue) === null || _b === void 0 ? void 0 : _b.toString()),
        performedBy: executionData === null || executionData === void 0 ? void 0 : executionData.performedBy,
        assignedTo: executionData === null || executionData === void 0 ? void 0 : executionData.assignedTo,
        teamSize: executionData === null || executionData === void 0 ? void 0 : executionData.noOfPersons,
        startDateTime: executionData === null || executionData === void 0 ? void 0 : executionData.startDateTime,
        completionDateTime: executionData === null || executionData === void 0 ? void 0 : executionData.completionDateTime
    };
}
