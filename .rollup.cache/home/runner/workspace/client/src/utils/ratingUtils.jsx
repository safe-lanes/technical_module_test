export var effectivenessRatings = [
    {
...
export var getScoreColors = function (score) {
    if (score >= 4.0) {
...
export var getRatingValue = function (ratingString) {
    if (ratingString.startsWith("5-"))
        return 5;
    if (ratingString.startsWith("4-"))
        return 4;
    if (ratingString.startsWith("3-"))
        return 3;
    if (ratingString.startsWith("2-"))
        return 2;
    if (ratingString.startsWith("1-"))
        return 1;
    return 0;
};
// Helper function to calculate weighted scores
export var calculateWeightedScore = function (assessments) {
    var totalScore = 0;
    var totalWeight = 0;
    assessments.forEach(function (assessment) {
        if (assessment.effectiveness && assessment.weight) {
            var rating = getRatingValue(assessment.effectiveness);
...
export var getStatusColors = function (status) {
    switch (status) {
        case "Proposed":
            return "bg-gray-200";
        case "Approved":
...
//# sourceMappingURL=ratingUtils.jsx.map