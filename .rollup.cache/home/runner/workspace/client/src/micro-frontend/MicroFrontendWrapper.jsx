...
export var MicroFrontendWrapper = function (_a) {
    var children = _a.children, _b = _a.config, initialConfig = _b === void 0 ? {} : _b;
    var _c = useState(__assign({ standalone: true, apiBaseUrl: '/api' }, initialConfig)), config = _c[0], setConfig = _c[1];
        ...
        if (!config.standalone && config.authToken) {
            ...
            window.fetch = function (input, init) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    return [2 /*return*/, originalFetch_1(input, __assign(__assign({}, init), { headers: headers }))];
                });
            }); };
            return function () {
    ...
    useEffect(function () {
        if (!config.standalone && config.apiBaseUrl) {
            ...
            queryClient.setDefaultOptions({
                queries: __assign(__assign({}, queryClient.getDefaultOptions().queries), { queryFn: function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
                        var url, response;
    ...
    return (<MicroFrontendContext.Provider value={{ config: config, updateConfig: updateConfig }}>
      <QueryClientProvider client={queryClient}>
        <TooltipProvider>
          <div className={"micro-frontend-app ".concat(!config.standalone ? 'micro-frontend-isolated' : '')} data-micro-frontend="element-crew-appraisals">
            {children}
          </div>
        </TooltipProvider>
      </QueryClientProvider>
