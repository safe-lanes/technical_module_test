...
export default function FormSchemaEditor(_a) {
  var open = _a.open,
    ...
    version = _a.version,
    formName = _a.formName,
    onUpdate = _a.onUpdate;
  var _b = useState('visual'),
    activeTab = _b[0],
    setActiveTab = _b[1];
  var _c = useState({ title: '', sections: [] }),
    schema = _c[0],
    setSchema = _c[1];
  var _d = useState(null),
    selectedSection = _d[0],
    setSelectedSection = _d[1];
  var _e = useState(false),
    publishDialogOpen = _e[0],
    setPublishDialogOpen = _e[1];
  var _f = useState(''),
    changelog = _f[0],
    setChangelog = _f[1];
  ...
  var updateSchemaMutation = useMutation({
    mutationFn: function (schemaJson) {
      return apiRequest(
        '/api/admin/forms/'
          .concat(version.formId, '/versions/')
          .concat(version.id, '/schema'),
        {
          method: 'PUT',
  ...
  var addSection = function () {
    ...
    setSchema(
      __assign(__assign({}, schema), {
        sections: __spreadArray(
          __spreadArray([], schema.sections, true),
          [newSection],
          false
        ),
      })
  ...
  var deleteSection = function (index) {
    var newSections = schema.sections.filter(function (_, i) {
      return i !== index;
    });
    setSchema(__assign(__assign({}, schema), { sections: newSections }));
  };
                ...
                {version.status === 'DRAFT' && (
                  <>
                    ...
                    <Button
                      size='sm'
                      onClick={function () {
                        return setPublishDialogOpen(true);
                      }}
          ...
          >
            ...
            <TabsContent value='visual' className='flex-1 overflow-y-auto'>
              <div className='space-y-4 p-4'>
                ...
                {schema.sections.map(function (section, sIndex) {
                  return (
                    <Card key={section.key}>
                      ...
                      <CardContent>
                        <div className='space-y-2'>
                          ...
                          {section.fields.map(function (field, fIndex) {
                            return (
                              <div
                                key={field.key}
                              ...
                              >
                                ...
                                <Button
                                  ...
                                  variant='ghost'
                                  onClick={function () {
                                    return deleteField(sIndex, fIndex);
                                  }}
                                >
            ...
            <TabsContent value='preview' className='flex-1 overflow-y-auto'>
              <div className='p-4'>
                <div className='border rounded-lg p-6 bg-gray-50'>
                  ...
                  {schema.sections.map(function (section) {
                    return (
        ...
        <DialogContent>
          ...
          <DialogFooter>
            <Button
              variant='outline'
              onClick={function () {
                return setPublishDialogOpen(false);
              }}
            >
              Cancel
            </Button>
