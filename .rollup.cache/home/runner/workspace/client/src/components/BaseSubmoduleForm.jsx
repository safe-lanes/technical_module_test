...
export var BaseSubmoduleForm = function (_a) {
  ...
  var _c = useState(
      ((_b = sections[0]) === null || _b === void 0 ? void 0 : _b.id) || ''
    ),
    activeSection = _c[0],
                  ...
                  return (
                    <div key={section.id} className='relative'>
                      <button
                        ...
                        className={'w-full flex items-center p-3 rounded-lg text-left transition-colors hover:bg-gray-50 '.concat(
                          isActive ? 'bg-blue-50' : ''
                        )}
                      >
                        <div
                          className={'w-10 h-10 rounded-full flex items-center justify-center text-white font-semibold mr-4 '.concat(
                            isActive
                              ? 'bg-blue-600'
                              : isCompleted
                                ? 'bg-green-500'
...
export var SAILInput = function (props) {
  return (
    <Input
      {...props}
      className={'bg-[#ffffff] '.concat(props.className || '')}
    />
  );
};
...
export var SAILButton = function (_a) {
  var _b = _a.variant,
    ...
    props = __rest(_a, ['variant', 'children', 'className']);
  ...
  return (
    <Button
      className={'px-8 '.concat(getVariantClasses(), ' ').concat(className)}
      {...props}
    >
      {children}
    </Button>
