...
export var ReviewChangesDrawer = function (_a) {
  ...
  var _b = useChangeMode(),
    getDiffs = _b.getDiffs,
    changeRequestTitle = _b.changeRequestTitle,
    changeRequestCategory = _b.changeRequestCategory,
    originalSnapshot = _b.originalSnapshot,
    reset = _b.reset;
  var _c = useState(''),
    reason = _c[0],
    setReason = _c[1];
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              apiRequest('POST', '/api/change-requests', {
              ...
              return (
                <div key={section}>
                  ...
                  <div className='space-y-3'>
                    {sectionDiffs.map(function (diff, index) {
                      return (
