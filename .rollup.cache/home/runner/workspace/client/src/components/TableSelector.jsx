...
export function TableSelector(_a) {
  ...
  var _b = useState('all'),
    criticalityFilter = _b[0],
    setCriticalityFilter = _b[1];
  var _c = useState('all'),
    stockFilter = _c[0],
    setStockFilter = _c[1];
    ...
    if (searchQuery) {
      filtered = filtered.filter(function (item) {
        ...
        if (category === 'work_orders') {
          return (
            ((_a = item.woNo) === null || _a === void 0
              ? void 0
              : _a.toLowerCase().includes(lowerQuery)) ||
            ((_b = item.jobTitle) === null || _b === void 0
              ? void 0
              : _b.toLowerCase().includes(lowerQuery)) ||
            ((_c = item.componentName) === null || _c === void 0
              ? void 0
              : _c.toLowerCase().includes(lowerQuery))
          );
        } else if (category === 'spares') {
          return (
            ((_d = item.partCode) === null || _d === void 0
              ? void 0
              : _d.toLowerCase().includes(lowerQuery)) ||
            ((_e = item.partName) === null || _e === void 0
              ? void 0
              : _e.toLowerCase().includes(lowerQuery)) ||
            ((_f = item.componentName) === null || _f === void 0
              ? void 0
              : _f.toLowerCase().includes(lowerQuery))
          );
        } else if (category === 'stores') {
          return (
            ((_g = item.itemCode) === null || _g === void 0
              ? void 0
              : _g.toLowerCase().includes(lowerQuery)) ||
            ((_h = item.itemName) === null || _h === void 0
              ? void 0
              : _h.toLowerCase().includes(lowerQuery)) ||
            ((_j = item.storesCategory) === null || _j === void 0
              ? void 0
              : _j.toLowerCase().includes(lowerQuery))
          );
        }
        return false;
      });
    ...
    <div className='h-full flex flex-col'>
      <div className='p-4 border-b space-y-3'>
        <div className='relative'>
          ...
          <Input
            type='text'
            placeholder={'Search '.concat(category.replace('_', ' '), '...')}
            value={searchQuery}
            onChange={function (e) {
              ...
              {filteredItems.map(function (item) {
                return (
                  <TableRow
                    ...
                    className={'cursor-pointer hover:bg-gray-50 '.concat(
                      (selectedItem === null || selectedItem === void 0
                        ? void 0
                  ...
                  >
                    ...
                    {category === 'spares' && (
                      <>
                        ...
                        <TableCell>
                          {getStockBadge(item.rob, item.min)}
                        </TableCell>
                      </>
                    )}
                    {category === 'stores' && (
