...
export function ModuleNavigator(_a) {
  var currentModule = _a.currentModule,
    onModuleChange = _a.onModuleChange;
  var _b = useState(false),
    showModuleDialog = _b[0],
    setShowModuleDialog = _b[1];
  var modules = [
    {
      id: 'technical-pms',
      name: 'Technical (PMS)',
  ...
  return (
    <>
      <div
        ...
        onClick={function () {
          return setShowModuleDialog(true);
        }}
      >
            ...
            {modules.map(function (module) {
              return (
                <Button
                  ...
                  onClick={function () {
                    return handleModuleSelect(module.id);
                  }}
