...
function ComponentTreeSelector(_a) {
  ...
  var _b = useState([]),
    components = _b[0],
    setComponents = _b[1];
  var _c = useState(new Set()),
    expandedNodes = _c[0],
    setExpandedNodes = _c[1];
  var _d = useState(null),
    selectedComponent = _d[0],
    setSelectedComponent = _d[1];
  useEffect(
    function () {
      if (open) {
        // Fetch components
      ...
      return (
        <div key={node.id || node.code}>
          <div
            ...
            style={{ paddingLeft: ''.concat(level * 20 + 8, 'px') }}
            onClick={function () {
              return setSelectedComponent(node);
            }}
          >
...
export function ProposeChanges(_a) {
  var targetType = _a.targetType,
    snapshotData = _a.snapshotData,
    _b = _a.existingProposedChanges,
    existingProposedChanges = _b === void 0 ? [] : _b,
    _c = _a.existingMovePreview,
    existingMovePreview = _c === void 0 ? null : _c,
    onSaveProposed = _a.onSaveProposed,
    _d = _a.disabled,
    disabled = _d === void 0 ? false : _d;
  var _e = useState({}),
    proposedFields = _e[0],
    setProposedFields = _e[1];
  var _f = useState({}),
    fieldValues = _f[0],
    setFieldValues = _f[1];
  var _g = useState(existingMovePreview),
    movePreview = _g[0],
    setMovePreview = _g[1];
  var _h = useState(false),
    showReviewDialog = _h[0],
    setShowReviewDialog = _h[1];
  var _j = useState(false),
    showTreeSelector = _j[0],
    setShowTreeSelector = _j[1];
  var _k = useState([]),
    pendingChanges = _k[0],
    setPendingChanges = _k[1];
  ...
  var getFieldLabel = function (path, type) {
    ...
    var fieldKey = path.split('.').pop() || path;
    return (
      ((_a = labels[type]) === null || _a === void 0 ? void 0 : _a[fieldKey]) ||
      fieldKey
    );
  };
  ...
  var handleNewParentSelect = function (parent) {
    ...
    var currentCode =
      ((_a = snapshotData.fields) === null || _a === void 0
        ? void 0
        : _a.code) || '';
    ...
    var newPath = ''
      .concat(parent.name, ' > ')
      .concat(snapshotData.displayName);
    setMovePreview({
      oldPath: oldPath,
      newPath: newPath,
      oldCode: currentCode,
      ...
      <>
        ...
        <div className='grid grid-cols-12 gap-4 items-center py-2 border-b'>
          ...
          <div className='col-span-4'>
            <Input
              ...
              onChange={function (e) {
                return handleFieldChange('jobTitle', e.target.value);
              }}
          ...
          <div className='col-span-4'>
            <Select
              ...
              onValueChange={function (value) {
                return handleFieldChange('frequencyType', value);
              }}
          ...
          <div className='col-span-4'>
            <div className='flex gap-2'>
              <Input
                ...
                min='1'
                value={
                  fieldValues['frequencyValue'] || fields.frequencyValue || ''
                }
                onChange={function (e) {
              ...
              {(fieldValues['frequencyType'] || fields.frequencyType) ===
                ...
                <Select
                  value={
                    fieldValues['frequencyUnit'] || fields.frequencyUnit || ''
                  }
                  onValueChange={function (value) {
        ...
        <div className='grid grid-cols-12 gap-4 items-center py-2 border-b'>
          ...
          <div className='col-span-4'>
            <Select
              value={
                ((_a = fieldValues['critical']) === null || _a === void 0
                  ? void 0
                  : _a.toString()) ||
                ((_b = fields.critical) === null || _b === void 0
                  ? void 0
                  : _b.toString()) ||
                'false'
              }
        ...
        <div className='grid grid-cols-12 gap-4 items-center py-2 border-b'>
          ...
          <div className='col-span-4'>
            <Select
              ...
              onValueChange={function (value) {
                return handleFieldChange('assignedTo', value);
              }}
        ...
        <div className='grid grid-cols-12 gap-4 items-start py-2 border-b'>
          ...
          <div className='col-span-4'>
            <Textarea
              ...
              onChange={function (e) {
                return handleFieldChange('instructions', e.target.value);
              }}
      ...
      <>
        ...
        <div className='grid grid-cols-12 gap-4 items-center py-2 border-b'>
          ...
          <div className='col-span-1'>
            <Switch
              ...
              onCheckedChange={function (checked) {
                return handleToggleField('maker', checked);
              }}
              disabled={disabled}
            />
          </div>
        ...
        <div className='grid grid-cols-12 gap-4 items-center py-2 border-b'>
          ...
          <div className='col-span-1'>
            <Switch
              ...
              onCheckedChange={function (checked) {
                return handleToggleField('model', checked);
              }}
              disabled={disabled}
            />
          </div>
        ...
        <div className='grid grid-cols-12 gap-4 items-center py-2 border-b'>
          ...
          <div className='col-span-4'>
            <Input
              ...
              onChange={function (e) {
                return handleFieldChange('deptCategory', e.target.value);
              }}
        ...
        <div className='grid grid-cols-12 gap-4 items-center py-2 border-b'>
          ...
          <div className='col-span-4'>
            <Input
              ...
              onChange={function (e) {
                return handleFieldChange('location', e.target.value);
              }}
        ...
        <div className='grid grid-cols-12 gap-4 items-center py-2 border-b'>
          ...
          <div className='col-span-4'>
            <Select
              value={
                ((_c = fieldValues['classItem']) === null || _c === void 0
                  ? void 0
                  : _c.toString()) ||
                ((_d = fields.classItem) === null || _d === void 0
                  ? void 0
                  : _d.toString()) ||
                'false'
              }
        ...
        <div className='mt-6'>
          ...
          {movePreview ? (
            ...
            <Button
              variant='outline'
              onClick={function () {
                return setShowTreeSelector(true);
              }}
              disabled={disabled}
            >
      ...
      <>
        ...
        <div className='grid grid-cols-12 gap-4 items-center py-2 border-b'>
          ...
          <div className='col-span-1'>
            <Switch
              ...
              onCheckedChange={function (checked) {
                return handleToggleField('uom', checked);
              }}
              disabled={disabled}
            />
          </div>
          <div className='col-span-4'>
            <Select
              ...
              onValueChange={function (value) {
                return handleFieldChange('uom', value);
              }}
        ...
        <div className='grid grid-cols-12 gap-4 items-center py-2 border-b'>
          ...
          <div className='col-span-1'>
            <Switch
              ...
              onCheckedChange={function (checked) {
                return handleToggleField('min', checked);
              }}
              disabled={disabled}
            />
          </div>
          <div className='col-span-4'>
            <Input
              ...
              value={
                (_b =
                  (_a = fieldValues['min']) !== null && _a !== void 0
                    ? _a
                    : fields.min) !== null && _b !== void 0
                  ? _b
                  : ''
              }
              onChange={function (e) {
        ...
        <div className='grid grid-cols-12 gap-4 items-center py-2 border-b'>
          ...
          <div className='col-span-4'>
            <Select
              value={
                ((_c = fieldValues['critical']) === null || _c === void 0
                  ? void 0
                  : _c.toString()) ||
                ((_d = fields.critical) === null || _d === void 0
                  ? void 0
                  : _d.toString()) ||
                'false'
              }
        ...
        {proposedFields['min'] && (
          <div className='mt-4 p-3 bg-blue-50 rounded-lg'>
            <p className='text-sm text-blue-800'>
              ...
              {getStockStatus(
                fields.rob,
                (_e = fieldValues['min']) !== null && _e !== void 0
                  ? _e
                  : fields.min
              )}{' '}
        ...
        <div className='grid grid-cols-12 gap-4 items-center py-2 border-b'>
          ...
          <div className='col-span-4'>
            <Input
              ...
              onChange={function (e) {
                return handleFieldChange('itemName', e.target.value);
              }}
        ...
        {proposedFields['min'] && (
          <div className='mt-4 p-3 bg-blue-50 rounded-lg'>
            <p className='text-sm text-blue-800'>
              ...
              {getStockStatus(
                fields.rob,
                (_c = fieldValues['min']) !== null && _c !== void 0
                  ? _c
                  : fields.min
              )}{' '}
              based on current ROB of {fields.rob || 0}.
        ...
        <CardContent>
          ...
          <div className='flex justify-between mt-6'>
            ...
            <Button
              ...
              disabled={
                disabled ||
                Object.keys(proposedFields).filter(function (k) {
                  return proposedFields[k];
                }).length === 0
              }
            >
              Review Changes
        ...
        <DialogContent className='max-w-4xl max-h-[80vh] overflow-y-auto'>
          ...
          {pendingChanges.length > 0 && (
            <div className='space-y-4'>
              <Table>
                ...
                <TableBody>
                  {pendingChanges.map(function (change, idx) {
                    return (
                      <TableRow key={idx}>
              ...
              {targetType === 'work_order' &&
                pendingChanges.some(function (c) {
                  return c.path.includes('frequency');
                }) && (
          ...
          <DialogFooter>
            <Button
              variant='outline'
              onClick={function () {
                return setShowReviewDialog(false);
              }}
            >
              Cancel
            </Button>
