    ...
    var renderTree = function (nodes, level) {
        ...
        <div className={cn('flex items-center py-2 px-2 hover:bg-gray-100 cursor-pointer rounded', (selectedComponent === null || selectedComponent === void 0 ? void 0 : selectedComponent.id) === node.id && 'bg-blue-50 border-blue-500')} style={{ paddingLeft: "".concat(level * 20 + 8, "px") }} onClick={function () { return setSelectedComponent(node); }}>
          {node.children && node.children.length > 0 && (<button onClick={function (e) {
              ...
              {expandedNodes.has(node.id || node.code) ? (<ChevronDown className='h-4 w-4'/>) : (<ChevronRight className='h-4 w-4'/>)}
            </button>)}
...
export function ProposeChanges(_a) {
    ...
    var renderWorkOrderFields = function () {
        ...
        <div className='grid grid-cols-12 gap-4 items-center py-2 border-b'>
          ...
          <div className='col-span-1'>
            <Switch checked={proposedFields['jobTitle'] || false} onCheckedChange={function (checked) {
                return handleToggleField('jobTitle', checked);
            }} disabled={disabled}/>
          </div>
          <div className='col-span-4'>
        ...
        <div className='grid grid-cols-12 gap-4 items-center py-2 border-b'>
          ...
          <div className='col-span-1'>
            <Switch checked={proposedFields['frequencyType'] || false} onCheckedChange={function (checked) {
                return handleToggleField('frequencyType', checked);
            }} disabled={disabled}/>
          </div>
          <div className='col-span-4'>
        ...
        <div className='grid grid-cols-12 gap-4 items-center py-2 border-b'>
          ...
          <div className='col-span-4'>
            <p className='text-sm'>
              {fields.frequencyValue}{' '}
              {fields.frequencyType === 'Period'
                ? fields.frequencyUnit
                : 'hours'}
            </p>
          </div>
          <div className='col-span-1'>
            <Switch checked={proposedFields['frequencyValue'] || false} onCheckedChange={function (checked) {
                return handleToggleField('frequencyValue', checked);
            }} disabled={disabled}/>
          </div>
          <div className='col-span-4'>
            <div className='flex gap-2'>
              <Input type='number' min='1' value={fieldValues['frequencyValue'] || fields.frequencyValue || ''} onChange={function (e) {
                return handleFieldChange('frequencyValue', parseInt(e.target.value));
            }} disabled={!proposedFields['frequencyValue'] || disabled} className='w-24'/>
              {(fieldValues['frequencyType'] || fields.frequencyType) ===
                'Period' && (<Select value={fieldValues['frequencyUnit'] || fields.frequencyUnit || ''} onValueChange={function (value) {
                    return handleFieldChange('frequencyUnit', value);
              ...
              {(fieldValues['frequencyType'] || fields.frequencyType) ===
                'Running Hours' && (<span className='flex items-center px-3'>hours</span>)}
            </div>
          </div>
        </div>
        ...
        <div className='grid grid-cols-12 gap-4 items-center py-2 border-b'>
          ...
          <div className='col-span-1'>
            <Switch checked={proposedFields['critical'] || false} onCheckedChange={function (checked) {
                return handleToggleField('critical', checked);
            }} disabled={disabled}/>
          </div>
          <div className='col-span-4'>
            <Select value={((_a = fieldValues['critical']) === null || _a === void 0 ? void 0 : _a.toString()) ||
                ((_b = fields.critical) === null || _b === void 0 ? void 0 : _b.toString()) ||
                'false'} onValueChange={function (value) {
                return handleFieldChange('critical', value === 'true');
        ...
        <div className='grid grid-cols-12 gap-4 items-center py-2 border-b'>
          ...
          <div className='col-span-1'>
            <Switch checked={proposedFields['assignedTo'] || false} onCheckedChange={function (checked) {
                return handleToggleField('assignedTo', checked);
            }} disabled={disabled}/>
          </div>
          <div className='col-span-4'>
        ...
        <div className='grid grid-cols-12 gap-4 items-start py-2 border-b'>
          ...
          <div className='col-span-1'>
            <Switch checked={proposedFields['instructions'] || false} onCheckedChange={function (checked) {
                return handleToggleField('instructions', checked);
            }} disabled={disabled}/>
          </div>
          <div className='col-span-4'>
    ...
    var renderComponentFields = function () {
        ...
        <div className='grid grid-cols-12 gap-4 items-center py-2 border-b'>
          ...
          <div className='col-span-1'>
            <Switch checked={proposedFields['serialNo'] || false} onCheckedChange={function (checked) {
                return handleToggleField('serialNo', checked);
            }} disabled={disabled}/>
          </div>
          <div className='col-span-4'>
        ...
        <div className='grid grid-cols-12 gap-4 items-center py-2 border-b'>
          ...
          <div className='col-span-1'>
            <Switch checked={proposedFields['deptCategory'] || false} onCheckedChange={function (checked) {
                return handleToggleField('deptCategory', checked);
            }} disabled={disabled}/>
          </div>
          <div className='col-span-4'>
        ...
        <div className='grid grid-cols-12 gap-4 items-center py-2 border-b'>
          ...
          <div className='col-span-1'>
            <Switch checked={proposedFields['location'] || false} onCheckedChange={function (checked) {
                return handleToggleField('location', checked);
            }} disabled={disabled}/>
          </div>
          <div className='col-span-4'>
        ...
        <div className='grid grid-cols-12 gap-4 items-center py-2 border-b'>
          ...
          <div className='col-span-1'>
            <Switch checked={proposedFields['commissionedDate'] || false} onCheckedChange={function (checked) {
                return handleToggleField('commissionedDate', checked);
            }} disabled={disabled}/>
          </div>
          <div className='col-span-4'>
            <Popover>
              ...
              <PopoverContent className='w-auto p-0'>
                <Calendar mode='single' selected={fieldValues['commissionedDate']
                ? new Date(fieldValues['commissionedDate'])
                : undefined} onSelect={function (date) {
                return handleFieldChange('commissionedDate', date === null || date === void 0 ? void 0 : date.toISOString());
            }}/>
              </PopoverContent>
            </Popover>
          </div>
        ...
        <div className='grid grid-cols-12 gap-4 items-center py-2 border-b'>
          ...
          <div className='col-span-1'>
            <Switch checked={proposedFields['classItem'] || false} onCheckedChange={function (checked) {
                return handleToggleField('classItem', checked);
            }} disabled={disabled}/>
          </div>
          <div className='col-span-4'>
            <Select value={((_c = fieldValues['classItem']) === null || _c === void 0 ? void 0 : _c.toString()) ||
                ((_d = fields.classItem) === null || _d === void 0 ? void 0 : _d.toString()) ||
                'false'} onValueChange={function (value) {
                return handleFieldChange('classItem', value === 'true');
    ...
    var renderSpareFields = function () {
        ...
        <div className='grid grid-cols-12 gap-4 items-center py-2 border-b'>
          ...
          <div className='col-span-4'>
            <Select value={fieldValues['uom'] || fields.uom || ''} onValueChange={function (value) { return handleFieldChange('uom', value); }} disabled={!proposedFields['uom'] || disabled}>
              ...
              <SelectContent>
                {uomOptions.map(function (uom) { return (<SelectItem key={uom} value={uom}>
                    {uom}
                  </SelectItem>); })}
              </SelectContent>
            </Select>
        ...
        <div className='grid grid-cols-12 gap-4 items-center py-2 border-b'>
          ...
          <div className='col-span-4'>
            <p className='text-sm'>
              {fields.min !== undefined ? fields.min : 'N/A'}
            </p>
          </div>
          <div className='col-span-1'>
          ...
          <div className='col-span-4'>
            <Input type='number' min='0' value={(_b = (_a = fieldValues['min']) !== null && _a !== void 0 ? _a : fields.min) !== null && _b !== void 0 ? _b : ''} onChange={function (e) {
                return handleFieldChange('min', e.target.value ? parseInt(e.target.value) : null);
            }} disabled={!proposedFields['min'] || disabled} placeholder='Enter minimum (blank for N/A)'/>
          </div>
        </div>
        ...
        <div className='grid grid-cols-12 gap-4 items-center py-2 border-b'>
          ...
          <div className='col-span-4'>
            <Select value={((_c = fieldValues['critical']) === null || _c === void 0 ? void 0 : _c.toString()) ||
                ((_d = fields.critical) === null || _d === void 0 ? void 0 : _d.toString()) ||
                'false'} onValueChange={function (value) {
                return handleFieldChange('critical', value === 'true');
            }} disabled={!proposedFields['critical'] || disabled}>
              <SelectTrigger>
    ...
    var renderStoreFields = function () {
        ...
        <div className='grid grid-cols-12 gap-4 items-center py-2 border-b'>
          ...
          <div className='col-span-1'>
            <Switch checked={proposedFields['itemName'] || false} onCheckedChange={function (checked) {
                return handleToggleField('itemName', checked);
            }} disabled={disabled}/>
          </div>
          <div className='col-span-4'>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <div className='flex justify-between mt-6'>
            ...
            <Button onClick={handleReviewChanges} disabled={disabled ||
            Object.keys(proposedFields).filter(function (k) { return proposedFields[k]; })
                .length === 0}>
              Review Changes
            </Button>
          </div>
        ...
        <DialogContent className='max-w-4xl max-h-[80vh] overflow-y-auto'>
          ...
          {pendingChanges.length > 0 && (<div className='space-y-4'>
                    ...
                    <div className='space-y-2'>
                      <div className='grid grid-cols-2 gap-4'>
                        ...
                        <div>
                          ...
                          <p className='text-xs text-gray-500 mt-1'>
                            New Code: {movePreview.newCodePreview}
                          </p>
                        </div>
                      </div>
                    </div>
              ...
              {targetType === 'work_order' &&
                pendingChanges.some(function (c) { return c.path.includes('frequency'); }) && (<div className='p-3 bg-yellow-50 rounded-lg'>
                    <p className='text-sm text-yellow-800'>
                      <strong>Note:</strong> If approved, next due date will be
                      recalculated per new frequency.
                    </p>
                  </div>)}
            </div>)}
