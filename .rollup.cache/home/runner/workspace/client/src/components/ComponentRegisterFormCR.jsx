...
var generateMockComponentData = function (component) {
  ...
  var baseData = {
    ...
    description: ''.concat(
      component.name,
      ' - Critical ship component for vessel operations'
    ),
    criticality: 'High',
    maker: isEngine
      ? 'MAN B&W'
    ...
    model: isEngine
      ...
      : isDeck
        ...
        : isHull
          ...
          : 'FXMQ-200',
    serialNo: 'SN-'
      .concat(component.code.replace(/\./g, ''), '-2024-')
      .concat(Math.floor(Math.random() * 9000) + 1000),
    ...
    dimensionsSize: isEngine
      ...
      : isDeck
        ...
        : isHull
          ...
          : '4m x 3m x 2.5m',
    notes:
      'Regular maintenance required. Last inspection completed successfully.',
...
export default function ComponentRegisterFormCR(_a) {
  ...
  var _d = useState(null),
    componentData = _d[0],
    setComponentData = _d[1];
  var _e = useState(null),
    originalData = _e[0],
    setOriginalData = _e[1];
  var _f = useState(new Map()),
    changeTracking = _f[0],
    setChangeTracking = _f[1];
  var _g = useState({}),
    sectionChangeCounts = _g[0],
    setSectionChangeCounts = _g[1];
  // State for Work Orders
  var _h = useState(new Set()),
    editingWorkOrders = _h[0],
    setEditingWorkOrders = _h[1];
  var _j = useState({}),
    workOrderErrors = _j[0],
    setWorkOrderErrors = _j[1];
  // State for Spares
  var _k = useState(false),
    showSpareLinkPicker = _k[0],
    setShowSpareLinkPicker = _k[1];
  var _l = useState(new Set()),
    selectedNewSpares = _l[0],
    setSelectedNewSpares = _l[1];
  var _m = useState(''),
    spareSearchQuery = _m[0],
    setSpareSearchQuery = _m[1];
  // State for expanded sections
  var _o = useState(new Set(['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H'])),
    expandedSections = _o[0],
    setExpandedSections = _o[1];
  ...
  // Track field changes
  var trackFieldChange = useCallback(
    function (path, newValue, section) {
      if (!originalData || !componentData) return;
      var originalValue = path.split('.').reduce(function (obj, key) {
        return obj === null || obj === void 0 ? void 0 : obj[key];
      }, originalData);
      if (JSON.stringify(originalValue) !== JSON.stringify(newValue)) {
        var newTracking = new Map(changeTracking);
        newTracking.set(path, {
          from: originalValue,
          to: newValue,
          path: path,
        });
  ...
  // Update section change counts
  var updateSectionChangeCount = useCallback(
    function () {
      var counts = {};
      ...
      if (
        componentData === null || componentData === void 0
          ? void 0
          : componentData.workOrders
      ) {
  ...
  var handleEditWorkOrder = function (woId) {
    ...
    setEditingWorkOrders(function (prev) {
      return new Set(prev).add(woId);
    });
    setComponentData(function (prev) {
      return __assign(__assign({}, prev), {
        workOrders: prev.workOrders.map(function (wo) {
          return wo.id === woId
            ? __assign(__assign({}, wo), {
                isEditing: true,
                originalData: __assign({}, wo),
              })
            : wo;
        }),
      });
  ...
  var handleSaveWorkOrderEdit = function (woId) {
    ...
    var wo =
      componentData === null || componentData === void 0
        ? void 0
        : componentData.workOrders.find(function (w) {
            return w.id === woId;
          });
    if (!wo) return;
    // Validate
    if (
      ...
      setWorkOrderErrors(
        ((_a = {}), (_a[woId] = 'Please fill all required fields'), _a)
      );
      return;
    }
    setEditingWorkOrders(function (prev) {
    ...
    setComponentData(function (prev) {
      return __assign(__assign({}, prev), {
        workOrders: prev.workOrders.map(function (w) {
          return w.id === woId
            ? __assign(__assign({}, w), { isEditing: false })
            : w;
        }),
      });
    });
        ...
        workOrders: prev.workOrders.map(function (wo) {
          if (wo.id === woId && wo.originalData) {
            var originalData_1 = wo.originalData,
              isEditing = wo.isEditing,
              rest = __rest(wo, ['originalData', 'isEditing']);
  ...
  var handleDeleteWorkOrder = function (woId) {
    ...
    setComponentData(function (prev) {
      return __assign(__assign({}, prev), {
        workOrders: prev.workOrders.map(function (wo) {
          return wo.id === woId
            ? __assign(__assign({}, wo), { pendingDelete: true })
            : wo;
        }),
      });
    });
  ...
  var handleAddWorkOrder = function () {
    ...
    setComponentData(function (prev) {
      return __assign(__assign({}, prev), {
        workOrders: __spreadArray(
          __spreadArray([], prev.workOrders, true),
          [newWO],
          false
        ),
      });
    ...
    setEditingWorkOrders(function (prev) {
      return new Set(prev).add(newWO.id);
    });
    updateSectionChangeCount();
  };
    ...
    setComponentData(function (prev) {
      return __assign(__assign({}, prev), {
        workOrders: prev.workOrders.map(function (wo) {
          var _a;
          return wo.id === woId
            ? __assign(__assign({}, wo), ((_a = {}), (_a[field] = value), _a))
            : wo;
        }),
      });
    });
  ...
  var handleEditSpare = function (spareId, field, value) {
    setComponentData(function (prev) {
      return __assign(__assign({}, prev), {
        spares: prev.spares.map(function (spare) {
          var _a;
          return spare.id === spareId
            ? __assign(
                __assign({}, spare),
                ((_a = {}), (_a[field] = value), (_a.isEditing = true), _a)
              )
            : spare;
        }),
      });
  ...
  var handleUnlinkSpare = function (spareId) {
    ...
    setComponentData(function (prev) {
      return __assign(__assign({}, prev), {
        spares: prev.spares.map(function (spare) {
          return spare.id === spareId
            ? __assign(__assign({}, spare), { pendingUnlink: true })
            : spare;
        }),
      });
    });
  ...
  var handleLinkNewSpares = function () {
    var newSpares = Array.from(selectedNewSpares).map(function (partCode) {
      var spare = availableSpares.find(function (s) {
        return s.partCode === partCode;
      });
      return __assign(__assign({}, spare), {
        id: 'linked-'.concat(partCode, '-').concat(Date.now()),
        isLinkedNew: true,
      });
    });
    setComponentData(function (prev) {
      return __assign(__assign({}, prev), {
        spares: __spreadArray(
          __spreadArray([], prev.spares, true),
          newSpares,
          true
        ),
      });
  ...
  var handleAddMetric = function () {
    ...
    setComponentData(function (prev) {
      return __assign(__assign({}, prev), {
        metrics: __spreadArray(
          __spreadArray([], prev.metrics || [], true),
          [newMetric],
          false
        ),
      });
  ...
  var handleMetricFieldChange = function (metricId, field, value) {
    ...
    setComponentData(function (prev) {
      return __assign(__assign({}, prev), {
        metrics: (prev.metrics || []).map(function (m) {
          var _a;
          if (m.id === metricId) {
      ...
      return __assign(__assign({}, prev), {
        metrics: (prev.metrics || []).map(function (m) {
          return m.id === metricId
            ? __assign(__assign({}, m), { pendingDelete: true })
            : m;
        }),
      });
    });
  ...
  var handleRestoreMetric = function (metricId) {
    ...
    setComponentData(function (prev) {
      return __assign(__assign({}, prev), {
        metrics: (prev.metrics || []).map(function (m) {
          return m.id === metricId
            ? __assign(__assign({}, m), { pendingDelete: false })
            : m;
        }),
      });
    });
  ...
  var buildChangeRequestPayload = function () {
    ...
    componentData.spares.forEach(function (spare) {
      if (spare.isLinkedNew && !spare.pendingUnlink) {
        ...
        var original = originalData.spares.find(function (s) {
          return s.id === spare.id;
        });
        if (original) {
          var fields = {};
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                apiRequest('POST', '/api/modify-pms/requests', payload),
              ];
            case 1:
              response = _a.sent();
  ...
  var handleSubmit = function () {
    ...
    var invalidWOs =
      componentData === null || componentData === void 0
        ? void 0
        : componentData.workOrders.filter(function (wo) {
            return (
              wo.isEditing &&
              (!wo.jobTitle ||
                !wo.frequencyType ||
  ...
  var filteredAvailableSpares = availableSpares.filter(function (spare) {
    return (
      !componentData.spares.some(function (s) {
        return s.partCode === spare.partCode;
      }) &&
                ...
                <div>
                  ...
                  <div className='border rounded-lg overflow-hidden'>
                    <table className='w-full'>
                      ...
                      <tbody>
                        {(_b = componentData.metrics) === null || _b === void 0
                          ? void 0
                          : _b.map(function (metric) {
                              return (
                                <tr
                                  key={metric.id}
                                  className={'\n                              '
                                ...
                                >
                                  <td className='px-4 py-2'>
                                    <Input
                                      value={metric.name}
                                      onChange={function (e) {
                                        return handleMetricFieldChange(
                                          metric.id,
                                          'name',
                                          e.target.value
                                        );
              ...
              <div>
                ...
                <div className='border rounded-lg overflow-hidden'>
                  <table className='w-full'>
                    ...
                    <tbody>
                      {componentData.workOrders.map(function (wo) {
                        return (
                          <tr
                            key={wo.id}
                            className={'\n                            '
                              ...
                              <>
                                <td className='px-4 py-2'>
                                  <Input
                                    value={wo.jobTitle}
                                    onChange={function (e) {
                                      return handleWorkOrderFieldChange(
                                        wo.id,
                                        'jobTitle',
                                        e.target.value
                                      );
                                    ...
                                    className={'h-8 '.concat(
                                      workOrderErrors[wo.id] && !wo.jobTitle
                                        ? 'border-red-500'
                                        : ''
                                    )}
            ...
            {expandedSections.has('E') && (
              <div>
                <div className='flex justify-end mb-4'>
                  <Button
                    onClick={function () {
                      return setShowSpareLinkPicker(true);
                    }}
                    className='bg-[#52baf3] hover:bg-[#4299d1] text-white'
                  >
                ...
                <div className='border rounded-lg overflow-hidden'>
                  <table className='w-full'>
                    ...
                    <tbody>
                      {componentData.spares.map(function (spare) {
                        return (
                          <tr
                            key={spare.id}
                            className={'\n                            '
                              ...
                              .concat(
                                spare.isEditing && !spare.isLinkedNew
                                  ? 'cr-modified-item'
                                  : '',
                                '\n                          '
                              )}
                          >
                            ...
                            <td className='px-4 py-2'>
                              <Input
                                ...
                                value={spare.min}
                                onChange={function (e) {
                                  return handleEditSpare(
                                    spare.id,
                                    'min',
                                    parseInt(e.target.value)
                                  );
                                }}
                                className={'h-8 w-20 '.concat(
                                  spare.isEditing ? 'cr-changed' : ''
                                )}
              ...
              <div className='space-y-4'>
                <div className='flex items-center gap-2'>
                  ...
                  <Input
                    ...
                    onChange={function (e) {
                      return setSpareSearchQuery(e.target.value);
                    }}
                  />
                </div>

                <div className='spare-link-picker'>
                  {filteredAvailableSpares.map(function (spare) {
                    return (
                      <div
                        key={spare.partCode}
                        className={'spare-link-item '.concat(
                          selectedNewSpares.has(spare.partCode)
                            ? 'selected'
                            : ''
                        )}
                        onClick={function () {
