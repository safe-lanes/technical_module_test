...
var StoresChangeRequestForm = function (_a) {
  var onClose = _a.onClose,
    ...
    _c = _a.category,
    category = _c === void 0 ? 'stores' : _c;
  var _d = useState(initialData.placeReceived || ''),
    placeReceived = _d[0],
    setPlaceReceived = _d[1];
  var _e = useState(initialData.dateReceived || ''),
    dateReceived = _e[0],
    setDateReceived = _e[1];
  var _f = useState([
      {
        itemCode:
  ...
  var getLabelStyle = function () {
    return 'block text-sm font-medium text-[#52baf3] mb-2';
  };
  var getHeaderStyle = function () {
    return 'text-sm font-medium text-[#52baf3]';
  };
    ...
    <div className='w-[95%] max-w-7xl max-h-[90vh] overflow-auto bg-white rounded-lg shadow-lg'>
      ...
      <div className='p-6'>
        ...
        <div className='grid grid-cols-2 gap-4 mb-6 p-4 bg-gray-50 rounded border border-[#52baf3]'>
          <div>
            ...
            <Input
              ...
              value={placeReceived}
              onChange={function (e) {
                return handleInputChange('placeReceived', e.target.value);
              }}
        ...
        <div className='grid grid-cols-8 gap-3 bg-gray-50 p-3 rounded-t border border-[#52baf3]'>
          {getColumnHeaders().map(function (header, index) {
            return (
              ...
              >
                ...
                <div
                  className={'text-sm font-medium '.concat(
                    newRob < minStock ? 'text-red-600' : 'text-[#52baf3]'
                  )}
                >
                  {item.newRob}
                </div>
                <div className='flex justify-center'>
                  <Button
                    ...
                    onClick={function () {
                      var comment = prompt(
                        'Add comment for '.concat(item.itemName, ':')
                      );
                      if (comment) {
