    ...
    return (<div className='w-[95%] max-w-7xl max-h-[90vh] overflow-auto bg-white rounded-lg shadow-lg'>
      ...
      <div className='p-6'>
        ...
        <div className='grid grid-cols-2 gap-4 mb-6 p-4 bg-gray-50 rounded border border-[#52baf3]'>
          ...
          <div>
            ...
            <div className='relative'>
              <Input type='date' value={dateReceived} onChange={function (e) {
            return handleInputChange('dateReceived', e.target.value);
        }} className={"pr-10 ".concat(getInputStyle('dateReceived'))}/>
        ...
        <div className='grid grid-cols-8 gap-3 bg-gray-50 p-3 rounded-t border border-[#52baf3]'>
          {getColumnHeaders().map(function (header, index) { return (<div key={index} className={getHeaderStyle()}>
              {header}
            </div>); })}
        </div>
        ...
        <div className='border border-t-0 rounded-b max-h-[400px] overflow-y-auto border-[#52baf3]'>
          {storeItems.map(function (item, index) {
            ...
            return (<div key={index} className='grid grid-cols-8 gap-3 p-3 border-b bg-white items-center'>
                ...
                <div>
                  <Input type='number' min='0' className={getItemInputStyle(index, 'consumed')} placeholder='0' value={item.consumed} onChange={function (e) {
                    return handleItemChange(index, 'consumed', e.target.value);
                }}/>
                </div>
                <div>
                  <Input type='number' min='0' className={getItemInputStyle(index, 'received')} placeholder='0' value={item.received} onChange={function (e) {
                    return handleItemChange(index, 'received', e.target.value);
                }}/>
                </div>
