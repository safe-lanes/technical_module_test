        ...
        <div className='border border-t-0 rounded-b border-[#52baf3]'>
          {spareItems.map(function (item, index) { return (<div key={index} className='grid grid-cols-12 gap-3 p-3 border-b bg-white items-center'>
              <div className='col-span-2'>
                <Input value={item.partCode} onChange={function (e) {
                return handleInputChange(index, 'partCode', e.target.value);
            }} placeholder={index === 0 ? 'SP-ME-001' : ''} className={getInputStyle(index, 'partCode')}/>
              </div>
              <div className='col-span-2'>
                <Input value={item.partName} onChange={function (e) {
                return handleInputChange(index, 'partName', e.target.value);
            }} placeholder={index === 0 ? 'Fuel Injector' : ''} className={getInputStyle(index, 'partName')}/>
              </div>
              <div className='col-span-3'>
                <Select value={item.linkedComponent} onValueChange={function (value) {
              ...
              <Input value={item.minQty} onChange={function (e) {
                return handleInputChange(index, 'minQty', e.target.value);
            }} placeholder={index === 0 ? '1' : ''} className={getInputStyle(index, 'minQty')}/>
              <Select value={item.critical} onValueChange={function (value) {
              ...
              <div className='col-span-2 flex items-center gap-2'>
                <Input value={item.location} onChange={function (e) {
                return handleInputChange(index, 'location', e.target.value);
            }} placeholder={index === 0 ? 'Store Room A' : ''} className={"flex-1 ".concat(getInputStyle(index, 'location'))}/>
