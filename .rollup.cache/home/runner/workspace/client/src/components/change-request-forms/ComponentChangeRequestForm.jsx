...
var ComponentChangeRequestForm = function (_a) {
    ...
    return (<div className='fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50'>
      <div className='bg-white rounded-lg w-full max-w-7xl h-[95vh] flex flex-col overflow-hidden'>
          ...
          <div className='border border-[#52baf3] rounded-lg p-4 mb-6'>
            ...
            <div className='grid grid-cols-4 gap-6'>
              ...
              <div className='space-y-2'>
                ...
                <Input value={componentData.componentCode} onChange={function (e) {
            return handleInputChange('componentCode', e.target.value);
        }} className={"text-sm ".concat(getInputStyle('componentCode'))}/>
              </div>
              <div className='space-y-2'>
                <div className='flex items-center gap-2'>
                  <Label className='text-sm text-[#52baf3]'>
                ...
                <Input value={componentData.equipmentCategory} onChange={function (e) {
            return handleInputChange('equipmentCategory', e.target.value);
        }} className={"text-sm ".concat(getInputStyle('equipmentCategory'))}/>
              </div>
              <div className='space-y-2'>
                <div className='flex items-center gap-2'>
        ...
        }} className={"text-sm ".concat(getInputStyle('installation'))}/>
              </div>
              <div className='space-y-2'>
                <div className='flex items-center gap-2'>
                  <Label className='text-sm text-[#52baf3]'>
                ...
                <Input type='date' value={componentData.commissioned} onChange={function (e) {
            return handleInputChange('commissioned', e.target.value);
        }} className={"text-sm ".concat(getInputStyle('commissioned'))}/>
              </div>
              <div className='space-y-2'>
                <div className='flex items-center gap-2'>
            ...
            return handleInputChange('conditionBased', value);
        }}>
        ...
        }} className={"text-sm ".concat(getInputStyle('equipmentDepartment'))}/>
              </div>
              <div className='space-y-2'>
                <div className='flex items-center gap-2'>
                  <Label className='text-sm text-[#52baf3]'>
        ...
        }} className={"text-sm ".concat(getInputStyle('parentComponent'))}/>
              </div>
              <div className='space-y-2'>
                <div className='flex items-center gap-2'>
                  <Label className='text-sm text-[#52baf3]'>
        ...
        }} className={"text-sm ".concat(getInputStyle('dimensionsSize'))}/>
              </div>
            </div>
        ...
        }} className={"text-sm ".concat(getInputStyle('runningHours'))} placeholder='20000'/>
              </div>
              <div className='space-y-2'>
                <div className='flex items-center gap-2'>
        ...
        }} className={"text-sm ".concat(getInputStyle('dateUpdated'))}/>
              </div>
            </div>
            ...
            <div className='space-y-4'>
              ...
              <div className='grid grid-cols-2 gap-6'>
                <div className='space-y-2'>
                  ...
                  <Input value={componentData.conditionMonitoringMetrics.metric} onChange={function (e) {
            return handleInputChange('conditionMonitoringMetrics.metric', e.target.value);
        }} className={"text-sm ".concat(getInputStyle('conditionMonitoringMetrics.metric'))}/>
                </div>
                <div className='space-y-2'>
                  <div className='flex items-center gap-2'>
                    <Label className='text-sm text-[#52baf3]'>
                  ...
                  <Input value={componentData.conditionMonitoringMetrics.alertsThresholds} onChange={function (e) {
            return handleInputChange('conditionMonitoringMetrics.alertsThresholds', e.target.value);
        }} className={"text-sm ".concat(getInputStyle('conditionMonitoringMetrics.alertsThresholds'))}/>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className='border border-[#52baf3] rounded-lg p-4 mb-6'>
            ...
            <div className='grid grid-cols-2 gap-6'>
              <div className='space-y-2'>
                ...
                <Input value={componentData.classificationData.classificationProvider} onChange={function (e) {
            return handleInputChange('classificationData.classificationProvider', e.target.value);
        }} className={"text-sm ".concat(getInputStyle('classificationData.classificationProvider'))}/>
              </div>
              <div className='space-y-2'>
                <div className='flex items-center gap-2'>
                  <Label className='text-sm text-[#52baf3]'>
        ...
        }} className={"text-sm ".concat(getInputStyle('classificationData.certificateNo'))}/>
              </div>
              <div className='space-y-2'>
                <div className='flex items-center gap-2'>
                  <Label className='text-sm text-[#52baf3]'>
                ...
                <Input type='date' value={componentData.classificationData.lastDataSurvey} onChange={function (e) {
            return handleInputChange('classificationData.lastDataSurvey', e.target.value);
        }} className={"text-sm ".concat(getInputStyle('classificationData.lastDataSurvey'))}/>
              </div>
              <div className='space-y-2'>
                <div className='flex items-center gap-2'>
                  <Label className='text-sm text-[#52baf3]'>
                ...
                <Input type='date' value={componentData.classificationData.nextDataSurvey} onChange={function (e) {
            return handleInputChange('classificationData.nextDataSurvey', e.target.value);
        }} className={"text-sm ".concat(getInputStyle('classificationData.nextDataSurvey'))}/>
              </div>
              <div className='space-y-2'>
                <div className='flex items-center gap-2'>
        ...
        }} className={"text-sm ".concat(getInputStyle('classificationData.surveyType'))}/>
              </div>
              <div className='space-y-2'>
                <div className='flex items-center gap-2'>
                  <Label className='text-sm text-[#52baf3]'>
        ...
        }} className={"text-sm ".concat(getInputStyle('classificationData.classRequirements'))}/>
              </div>
              <div className='space-y-2'>
                <div className='flex items-center gap-2'>
        ...
        }} className={"text-sm ".concat(getInputStyle('classificationData.classCode'))}/>
              </div>
              <div className='space-y-2'>
                <div className='flex items-center gap-2'>
        ...
        }} className={"text-sm ".concat(getInputStyle('classificationData.information'))}/>
              </div>
            </div>
          </div>
        </div>
