...
var ComponentChangeRequestForm = function (_a) {
  ...
  var _o = useState({
      ...
      conditionMonitoringMetrics: {
        metric:
          ((_b = initialData.conditionMonitoringMetrics) === null ||
          _b === void 0
            ? void 0
            : _b.metric) || 'Temperature',
        alertsThresholds:
          ((_c = initialData.conditionMonitoringMetrics) === null ||
          _c === void 0
            ? void 0
            : _c.alertsThresholds) || '85°C',
      },
      // Section G - Classification & Regulatory Data
      classificationData: {
        classificationProvider:
          ((_d = initialData.classificationData) === null || _d === void 0
            ? void 0
            : _d.classificationProvider) || 'DNV GL',
        certificateNo:
          ((_e = initialData.classificationData) === null || _e === void 0
            ? void 0
            : _e.certificateNo) || 'CERT-2020-001',
        lastDataSurvey:
          ((_f = initialData.classificationData) === null || _f === void 0
            ? void 0
            : _f.lastDataSurvey) || '2024-06-15',
        nextDataSurvey:
          ((_g = initialData.classificationData) === null || _g === void 0
            ? void 0
            : _g.nextDataSurvey) || '2025-06-15',
        surveyType:
          ((_h = initialData.classificationData) === null || _h === void 0
            ? void 0
            : _h.surveyType) || 'Annual',
        classRequirements:
          ((_j = initialData.classificationData) === null || _j === void 0
            ? void 0
            : _j.classRequirements) || 'Class A',
        classCode:
          ((_k = initialData.classificationData) === null || _k === void 0
            ? void 0
            : _k.classCode) || 'A1',
        information:
          ((_l = initialData.classificationData) === null || _l === void 0
            ? void 0
            : _l.information) || '',
      },
    }),
    componentData = _o[0],
    setComponentData = _o[1];
  var _p = useState(new Set()),
    changedFields = _p[0],
    setChangedFields = _p[1];
  var handleInputChange = function (field, value) {
    ...
    var initialValue = field.includes('.')
      ? (_a = initialData[field.split('.')[0]]) === null || _a === void 0
        ? void 0
        : _a[field.split('.')[1]]
      : initialData[field];
          ...
          <div className='border border-[#52baf3] rounded-lg p-4 mb-6'>
            ...
            <div className='grid grid-cols-4 gap-6'>
              ...
              <div className='space-y-2'>
                ...
                <Input
                  ...
                  className={'text-sm '.concat(getInputStyle('maker'))}
                />
              </div>
              <div className='space-y-2'>
                <div className='flex items-center gap-2'>
                ...
                <Input
                  ...
                  className={'text-sm '.concat(getInputStyle('model'))}
                />
              </div>
              <div className='space-y-2'>
                <div className='flex items-center gap-2'>
                ...
                <Input
                  ...
                  className={'text-sm '.concat(getInputStyle('serialNo'))}
                />
              </div>
              <div className='space-y-2'>
                <div className='flex items-center gap-2'>
                ...
                <Input
                  ...
                  className={'text-sm '.concat(getInputStyle('drawingNo'))}
                />
              </div>
              ...
              <div className='space-y-2'>
                ...
                <Input
                  ...
                  className={'text-sm '.concat(
                    getInputStyle('equipmentCategory')
                  )}
                />
              </div>
              <div className='space-y-2'>
                ...
                <Input
                  ...
                  className={'text-sm '.concat(getInputStyle('location'))}
                />
              </div>
              <div className='space-y-2'>
                <div className='flex items-center gap-2'>
                ...
                <Select
                  ...
                  onValueChange={function (value) {
                    return handleInputChange('critical', value);
                  }}
                >
                  <SelectTrigger
                    className={'text-sm '.concat(getInputStyle('critical'))}
                  >
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
              ...
              <div className='space-y-2'>
                ...
                <Input
                  ...
                  className={'text-sm '.concat(getInputStyle('rating'))}
                />
              </div>
              <div className='space-y-2'>
                <div className='flex items-center gap-2'>
              ...
              <div className='space-y-2'>
                ...
                <Input
                  ...
                  className={'text-sm '.concat(getInputStyle('noOfUnits'))}
                />
              </div>
              <div className='space-y-2'>
                <div className='flex items-center gap-2'>
                ...
                <Input
                  ...
                  className={'text-sm '.concat(
                    getInputStyle('equipmentDepartment')
                  )}
                />
              </div>
              <div className='space-y-2'>
            ...
            <div className='mt-6'>
              ...
              <Textarea
                ...
                className={'text-sm '.concat(getInputStyle('notes'))}
                rows={3}
            ...
            <div className='grid grid-cols-2 gap-6 mb-4'>
              <div className='space-y-2'>
                ...
                <Input
                  ...
                  className={'text-sm '.concat(getInputStyle('runningHours'))}
                  placeholder='20000'
                />
              </div>
              <div className='space-y-2'>
              ...
              <div className='grid grid-cols-2 gap-6'>
                <div className='space-y-2'>
                  ...
                  <Input
                    ...
                    className={'text-sm '.concat(
                      getInputStyle('conditionMonitoringMetrics.metric')
                    )}
                  />
                </div>
                <div className='space-y-2'>
              ...
              <table className='w-full border-collapse'>
                ...
                <tbody>
                  <tr className='border-b border-gray-100'>
                    <td className='p-3'>
                      <Input
                        className={'text-sm '.concat(getInputStyle('wo1'))}
                        defaultValue='WO-2025-01'
                      />
                    </td>
                    <td className='p-3'>
                      <Input
                        className={'text-sm '.concat(getInputStyle('wo1title'))}
                    ...
                    <td className='p-3'>
                      <Input
                        type='date'
                        className={'text-sm '.concat(getInputStyle('wo1due'))}
              ...
              <table className='w-full border-collapse'>
                ...
                <tbody>
                  <tr className='border-b border-gray-100'>
                    <td className='p-3'>
                      <Input
                        className={'text-sm '.concat(getInputStyle('mh1wo'))}
                        defaultValue='WO-2025-01'
                      />
                    </td>
                    <td className='p-3'>
                      <Input
                        className={'text-sm '.concat(getInputStyle('mh1by'))}
                        defaultValue='Kane'
                      />
                    </td>
                    <td className='p-3'>
                      <Input
                        className={'text-sm '.concat(getInputStyle('mh1hours'))}
                        defaultValue='3'
                      />
                    </td>
                    <td className='p-3'>
                      <Input
                        type='date'
                        className={'text-sm '.concat(getInputStyle('mh1date'))}
            ...
            <div className='grid grid-cols-2 gap-6'>
              <div className='space-y-2'>
                ...
                <Input
                  ...
                  className={'text-sm '.concat(
                    getInputStyle('classificationData.classificationProvider')
                  )}
                />
              </div>
              <div className='space-y-2'>
                ...
                <Input
                  ...
                  className={'text-sm '.concat(
                    getInputStyle('classificationData.certificateNo')
                  )}
                />
              </div>
              <div className='space-y-2'>
                ...
                <Input
                  ...
                  className={'text-sm '.concat(
                    getInputStyle('classificationData.lastDataSurvey')
                  )}
                />
              </div>
              <div className='space-y-2'>
                ...
                <Input
                  ...
                  className={'text-sm '.concat(
                    getInputStyle('classificationData.nextDataSurvey')
                  )}
                />
              </div>
              <div className='space-y-2'>
                ...
                <Input
                  ...
                  className={'text-sm '.concat(
                    getInputStyle('classificationData.surveyType')
                  )}
                />
              </div>
              <div className='space-y-2'>
                ...
                <Input
                  ...
                  className={'text-sm '.concat(
                    getInputStyle('classificationData.classRequirements')
                  )}
                />
              </div>
              <div className='space-y-2'>
                ...
                <Input
                  ...
                  className={'text-sm '.concat(
                    getInputStyle('classificationData.classCode')
                  )}
                />
              </div>
              <div className='space-y-2'>
                ...
                <Input
                  ...
                  className={'text-sm '.concat(
                    getInputStyle('classificationData.information')
                  )}
                />
              </div>
            </div>
