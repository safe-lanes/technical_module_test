        ...
        <div className="border border-[#52baf3] rounded-lg p-4 mb-6">
          ...
          <div className="grid grid-cols-3 gap-6">
            ...
            <div className="space-y-2">
              ...
              <Input value={workOrderData.workOrderNo} onChange={function (e) { return handleInputChange('workOrderNo', e.target.value); }} className={"text-sm ".concat(getInputStyle("workOrderNo"))}/>
            </div>
            <div className="space-y-2">
              <div className="flex items-center gap-2">
            ...
            <div className="space-y-2">
              ...
              <Select value={workOrderData.maintenanceType} onValueChange={function (value) { return handleInputChange('maintenanceType', value); }}>
            ...
            <div className="space-y-2">
              ...
              <Select value={workOrderData.assignedTo} onValueChange={function (value) { return handleInputChange('assignedTo', value); }}>
            ...
            <div className="space-y-2">
              ...
              <Select value={workOrderData.jobCategory} onValueChange={function (value) { return handleInputChange('jobCategory', value); }}>
            ...
            <div className="space-y-2">
              ...
              <Select value={workOrderData.classRelated} onValueChange={function (value) { return handleInputChange('classRelated', value); }}>
          ...
          <div className="mt-6">
            ...
            <Textarea value={workOrderData.briefWorkDescription} onChange={function (e) { return handleInputChange('briefWorkDescription', e.target.value); }} className={"text-sm ".concat(getInputStyle("briefWorkDescription"))} rows={3} placeholder="Add Work description"/>
          </div>
        </div>
        ...
        <div className="border border-[#52baf3] rounded-lg p-4 mb-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <Input value={workOrderData.ppeRequirements} onChange={function (e) { return handleInputChange('ppeRequirements', e.target.value); }} className={"text-sm ".concat(getInputStyle("ppeRequirements"))} placeholder="[Leather Gloves] [Goggles] [Safety Helmet]"/>
            </div>
            <div>
              <div className="flex items-center gap-2 mb-2">
              ...
              <Input value={workOrderData.permitRequirements} onChange={function (e) { return handleInputChange('permitRequirements', e.target.value); }} className={"text-sm ".concat(getInputStyle("permitRequirements"))} placeholder="[Enclosed Space Entry Permit]"/>
            </div>
            <div>
              <div className="flex items-center gap-2 mb-2">
              ...
              <Input value={workOrderData.otherSafetyRequirements} onChange={function (e) { return handleInputChange('otherSafetyRequirements', e.target.value); }} className={"text-sm ".concat(getInputStyle("otherSafetyRequirements"))} placeholder="Free Text"/>
            </div>
          </div>
        </div>
        </div>
