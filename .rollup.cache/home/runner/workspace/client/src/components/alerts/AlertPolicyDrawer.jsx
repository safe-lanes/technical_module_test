...
export default function AlertPolicyDrawer(_a) {
  ...
  var _d = useState({}),
    scopeFilters = _d[0],
    setScopeFilters = _d[1];
  var _e = useState({ roles: [], users: [] }),
    recipients = _e[0],
    setRecipients = _e[1];
  useEffect(
    function () {
      ...
      try {
        ...
        setRecipients(
          JSON.parse(policy.recipients || '{"roles":[],"users":[]}')
        );
      } catch (e) {
  ...
  var handleSave = function () {
    var updatedPolicy = __assign(__assign({}, localPolicy), {
        ...
        return (
          <>
            ...
            <div className='space-y-2'>
              ...
              <div className='space-y-2'>
                {certificateTypes.map(function (type) {
                  return (
          ...
          <TabsContent value='general' className='space-y-4'>
            <div className='flex items-center justify-between'>
              ...
              <Switch
                ...
                onCheckedChange={function (checked) {
                  return setLocalPolicy(
                    __assign(__assign({}, localPolicy), { enabled: checked })
                  );
                }}
              />
            </div>
            ...
            <div className='space-y-2'>
              ...
              <Select
                ...
                onValueChange={function (value) {
                  return setLocalPolicy(
                    __assign(__assign({}, localPolicy), { priority: value })
                  );
                }}
              >
            ...
            {(policy.alertType === 'maintenance_due' ||
              ...
              <div className='space-y-2'>
                ...
                <div className='space-y-2 max-h-60 overflow-y-auto'>
                  {componentCategories.map(function (category) {
                    return (
                      <div
                        key={category}
                      ...
                      >
                        <Checkbox
                          ...
                          onCheckedChange={function (checked) {
                            ...
                            if (checked) {
                              setScopeFilters(
                                __assign(__assign({}, scopeFilters), {
                                  categories: __spreadArray(
                                    __spreadArray([], categories, true),
                                    [category],
                                    false
                                  ),
                                })
                        ...
                        />
                        <Label htmlFor={'cat-'.concat(category)}>
                          {category}
                        </Label>
                      </div>
                    );
                    ...
                    <div key={role} className='flex items-center space-x-2'>
                      <Checkbox
                        ...
                        onCheckedChange={function (checked) {
                          ...
                          if (checked) {
                            setRecipients(
                              __assign(__assign({}, recipients), {
                                roles: __spreadArray(
                                  __spreadArray([], roles, true),
                                  [role],
                                  false
                                ),
                              })
            ...
            <div className='space-y-2'>
              ...
              <Input
                ...
                onChange={function (e) {
                  ...
                  setRecipients(
                    __assign(__assign({}, recipients), { users: users })
                  );
                }}
        ...
        <Card className='mt-6'>
          ...
          <CardContent className='space-y-4'>
            <div className='p-4 bg-gray-50 rounded-lg'>
              ...
              <p className='text-sm text-gray-600'>
                {policy.alertType === 'maintenance_due' &&
                  'Maintenance is due in '.concat(
                    thresholds.daysBeforeDue || 7,
                    ' days for Main Engine. Please schedule the maintenance task.'
                  )}
                {policy.alertType === 'critical_inventory' &&
                ...
                {policy.alertType === 'certificate_expiration' &&
                  'Certificate "Class Certificate" is expiring in '.concat(
                    thresholds.daysBeforeExpiry || 30,
                    ' days. Please arrange renewal.'
                  )}
