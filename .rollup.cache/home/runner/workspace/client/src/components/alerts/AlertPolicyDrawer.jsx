    ...
    var renderThresholdFields = function () {
        switch (policy.alertType) {
            ...
            <div className="space-y-2">
              ...
              <Input id="days-before" type="number" value={thresholds.daysBeforeDue || 7} onChange={function (e) { return setThresholds(__assign(__assign({}, thresholds), { daysBeforeDue: parseInt(e.target.value) })); }}/>
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input id="hours-before" type="number" value={thresholds.hoursBeforeService || 100} onChange={function (e) { return setThresholds(__assign(__assign({}, thresholds), { hoursBeforeService: parseInt(e.target.value) })); }}/>
            </div>
            <div className="space-y-2">
              <Label htmlFor="utilization-spike">Utilization Spike % (Optional)</Label>
              <Input id="utilization-spike" type="number" value={thresholds.utilizationSpikePercent || ''} onChange={function (e) { return setThresholds(__assign(__assign({}, thresholds), { utilizationSpikePercent: e.target.value ? parseInt(e.target.value) : null })); }} placeholder="Leave empty to disable"/>
            </div>
          </>);
            ...
            <div className="space-y-2">
              ...
              <Input id="buffer-qty" type="number" value={thresholds.bufferQty || 0} onChange={function (e) { return setThresholds(__assign(__assign({}, thresholds), { bufferQty: parseInt(e.target.value) })); }}/>
            </div>
            <div className="flex items-center space-x-2">
            ...
            <div className="space-y-2">
              ...
              <Input id="days-expiry" type="number" value={thresholds.daysBeforeExpiry || 30} onChange={function (e) { return setThresholds(__assign(__assign({}, thresholds), { daysBeforeExpiry: parseInt(e.target.value) })); }}/>
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <Input id="max-age" type="number" value={thresholds.maxAgeHours || 26} onChange={function (e) { return setThresholds(__assign(__assign({}, thresholds), { maxAgeHours: parseInt(e.target.value) })); }}/>
            </div>
          </>);
            default:
                return null;
        ...
        <Tabs defaultValue="general" className="mt-6">
          ...
          <TabsContent value="general" className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Select value={localPolicy.priority || 'medium'} onValueChange={function (value) { return setLocalPolicy(__assign(__assign({}, localPolicy), { priority: value })); }}>
          ...
          <TabsContent value="scope" className="space-y-4">
            {(policy.alertType === 'maintenance_due' || policy.alertType === 'running_hours') && (<div className="space-y-2">
            ...
            {policy.alertType === 'critical_inventory' && (<div className="space-y-2">
                ...
                <Input id="location" value={scopeFilters.location || ''} onChange={function (e) { return setScopeFilters(__assign(__assign({}, scopeFilters), { location: e.target.value })); }} placeholder="e.g., Engine Room"/>
              </div>)}
          </TabsContent>
          ...
          <TabsContent value="recipients" className="space-y-4">
            ...
            var users = e.target.value.split(',').map(function (u) { return u.trim(); }).filter(function (u) { return u; });
