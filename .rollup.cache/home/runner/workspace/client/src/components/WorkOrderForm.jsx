...
var WorkOrderForm = function (_a) {
  var isOpen = _a.isOpen,
    ...
    workOrder = _a.workOrder,
    _b = _a.isApprovalMode,
    isApprovalMode = _b === void 0 ? false : _b;
  var toast = useToast().toast;
  var _c = useState('partA'),
    activeSection = _c[0],
    setActiveSection = _c[1];
  var _d = useState(false),
    isWorkInstructionsOpen = _d[0],
    setIsWorkInstructionsOpen = _d[1];
  var _e = useState(''),
    rejectionComments = _e[0],
    setRejectionComments = _e[1];
  var _f = useState(false),
    showRejectionComments = _f[0],
    setShowRejectionComments = _f[1];
  var _g = useLocation(),
    location = _g[0],
    setLocation = _g[1];
  // Preview mode state
  var _h = useState(false),
    isPreviewMode = _h[0],
    setIsPreviewMode = _h[1];
  var _j = useState(null),
    changeRequestData = _j[0],
    setChangeRequestData = _j[1];
  var _k = useState({}),
    previewChanges = _k[0],
    setPreviewChanges = _k[1];
  // Quick Input functionality for Work Carried Out
  var workCarriedOutRef = useRef(null);
  var _l = useState(false),
    showQuickInputs = _l[0],
    setShowQuickInputs = _l[1];
  // Smart Suggestions functionality
  var _m = useState(false),
    showSmartSuggestions = _m[0],
    setShowSmartSuggestions = _m[1];
  var _o = useState([]),
    smartSuggestions = _o[0],
    setSmartSuggestions = _o[1];
  ...
  var _p = useModifyMode(),
    isModifyMode = _p.isModifyMode,
    targetId = _p.targetId,
    fieldChanges = _p.fieldChanges,
    trackFieldChange = _p.trackFieldChange,
  ...
  var getPreviewValue = function (fieldName) {
    var _a;
    return (
      ((_a = previewChanges[fieldName]) === null || _a === void 0
        ? void 0
        : _a.newValue) || ''
    );
  };
  ...
  var generateWOTemplateCode = function () {
    var compCode =
      ...
      (component === null || component === void 0 ? void 0 : component.code);
    ...
    function () {
      if (!templateData.woTemplateCode) {
        ...
        setTemplateData(function (prev) {
          return __assign(__assign({}, prev), { woTemplateCode: newCode_1 });
        });
      }
    },
    [
  ...
  useEffect(
    function () {
      if (workOrder) {
        ...
        setTemplateData(function (prev) {
          return __assign(__assign({}, prev), initialData_1);
        });
    ...
    if (activeSection === 'partA') {
      ...
      if (onSubmit) {
        var workOrderId =
          (workOrder === null || workOrder === void 0
            ? void 0
            : workOrder.id) || 'new-'.concat(Date.now());
        onSubmit(workOrderId, {
          type: 'template',
          data: __assign(__assign({}, templateData), {
      ...
      if (onSubmit) {
        var workOrderId =
          (workOrder === null || workOrder === void 0
            ? void 0
            : workOrder.id) || 'new-'.concat(Date.now());
        var executionRecord = __assign(
          __assign(__assign({}, templateData), executionData),
          {
            woExecutionId:
    ...
    if (onReject) {
      onReject(
        (workOrder === null || workOrder === void 0
          ? void 0
          : workOrder.executionId) ||
          (workOrder === null || workOrder === void 0 ? void 0 : workOrder.id),
        rejectionComments
      );
    }
    toast({
                        ...
                        <div className='space-y-2'>
                          ...
                          <ModifyFieldWrapper
                            originalValue={
                              (workOrder === null || workOrder === void 0
                                ? void 0
                                : workOrder.frequencyUnit) || 'Months'
                            }
                    ...
                    <div className='mt-6'>
                      ...
                      <ModifyFieldWrapper
                        originalValue={
                          (workOrder === null || workOrder === void 0
                            ? void 0
                            : workOrder.briefWorkDescription) || ''
                        }
                          ...
                          return __awaiter(void 0, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                              switch (_a.label) {
                                ...
                                case 1:
                                  _a.trys.push([1, 6, , 7]);
                                  proposedChanges = Object.entries(
                                    fieldChanges
                                  ).map(function (_a) {
                                    var fieldName = _a[0],
                                      change = _a[1];
                                  ...
                                  changeRequest = {
                                    vesselId: 'V001',
                                    category: 'workOrders',
                                    title: 'Modify Work Order: '.concat(
                                      (workOrder === null ||
                                      workOrder === void 0
                                        ? void 0
                                        : workOrder.jobTitle) ||
                                ...
                                case 2:
                                  ...
                                  toast({
                                    ...
                                    description:
                                      'Your change request with '.concat(
                                        Object.keys(fieldChanges).length,
                                        ' modifications has been submitted for approval.'
                                      ),
                                  });
                                  onClose();
                        ...
                        {showQuickInputs && (
                          <div className='mb-3 p-3 bg-gray-50 rounded-lg border'>
                            ...
                            <div className='flex flex-wrap gap-1'>
                              {quickAnswers.map(function (answer, index) {
                                return (
                                  <button
                                    key={index}
                                    type='button'
                                    onClick={function () {
                                      return insertQuickText(answer);
                                    }}
                  ...
                  {isApprovalMode && (
                    <div className='border border-gray-200 rounded-lg p-4 mb-6'>
                      ...
                      <Textarea
                        ...
                        onChange={function (e) {
                          return setRejectionComments(e.target.value);
                        }}
