        ...
        <div className='space-y-4 py-4'>
          ...
          <div className='grid grid-cols-2 gap-6'>
            <div className='space-y-2'>
              ...
              <Input id='workOrderId' value={formData.workOrderId} onChange={function (e) {
            return setFormData(__assign(__assign({}, formData), { workOrderId: e.target.value }));
        }} className='bg-gray-50' readOnly/>
            </div>
            <div className='space-y-2'>
              <Label htmlFor='component'>Component</Label>
              <Input id='component' value={formData.component} onChange={function (e) {
            return setFormData(__assign(__assign({}, formData), { component: e.target.value }));
        }} className='bg-gray-50' readOnly/>
            </div>
          </div>
          ...
          <div className='grid grid-cols-2 gap-6'>
            <div className='space-y-2'>
              ...
              <Input id='jobTitle' value={formData.jobTitle} onChange={function (e) {
            return setFormData(__assign(__assign({}, formData), { jobTitle: e.target.value }));
        }} className='bg-gray-50' readOnly/>
            </div>
            <div className='space-y-2'>
              <Label></Label>
            ...
            return setFormData(__assign(__assign({}, formData), { informOfficer: checked }));
                ...
                <Label htmlFor='informOfficer' className='text-sm'>
                  Inform Office
                </Label>
              </div>
            </div>
          ...
          <div className='grid grid-cols-2 gap-6'>
            <div className='space-y-2'>
              ...
              <Input id='originalDueDate' value={formData.originalDueDate} onChange={function (e) {
            return setFormData(__assign(__assign({}, formData), { originalDueDate: e.target.value }));
        }} className='bg-gray-50' readOnly/>
            </div>
            <div></div>
          </div>
          ...
          <div className='space-y-2'>
            <Label htmlFor='reasonForPostponement'>
              Reason for Postponement
            </Label>
            <Textarea id='reasonForPostponement' value={formData.reasonForPostponement} onChange={function (e) {
            return setFormData(__assign(__assign({}, formData), { reasonForPostponement: e.target.value }));
        }} className='min-h-[80px]' placeholder='Enter reason for postponement...'/>
          </div>
          ...
          <div className='grid grid-cols-2 gap-6'>
            <div className='space-y-2'>
              ...
              <Select value={formData.authorizedBy} onValueChange={function (value) {
            return setFormData(__assign(__assign({}, formData), { authorizedBy: value }));
        }}>
                <SelectTrigger>
          ...
          <div className='space-y-2'>
            ...
            <Textarea id='approvalRemarks' value={formData.approvalRemarks} onChange={function (e) {
            return setFormData(__assign(__assign({}, formData), { approvalRemarks: e.target.value }));
        }} className='min-h-[60px]' placeholder='Enter approval remarks...'/>
          </div>
          ...
          <div className='grid grid-cols-2 gap-6'>
            <div className='space-y-2'>
              ...
              <Input id='nextDueDate' type='date' value={formData.nextDueDate} onChange={function (e) {
            return setFormData(__assign(__assign({}, formData), { nextDueDate: e.target.value }));
        }} placeholder='dd-mm-yyyy'/>
            </div>
            <div className='space-y-2'>
              <Label htmlFor='durationOfPostponement'>
                Duration of Postponement
              </Label>
              <Select value={formData.durationOfPostponement} onValueChange={function (value) {
            return setFormData(__assign(__assign({}, formData), { durationOfPostponement: value }));
        }}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
          ...
          <div className='space-y-2'>
            ...
            return setFormData(__assign(__assign({}, formData), { attachDocument: checked }));
              ...
              <Label htmlFor='attachDocument' className='text-sm'>
