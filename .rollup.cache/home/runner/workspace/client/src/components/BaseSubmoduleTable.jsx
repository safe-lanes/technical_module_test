...
export var BaseSubmoduleTable = function (_a) {
  var title = _a.title,
    ...
    _d = _a.activeModule,
    activeModule = _d === void 0 ? 'Appraisals' : _d;
  var _e = useState(true),
    showFilters = _e[0],
    setShowFilters = _e[1];
  var _f = useState({}),
    filterValues = _f[0],
    setFilterValues = _f[1];
              ...
              <Link href='/admin'>
                <div className='flex flex-col items-center justify-center w-[100px] h-[67px] bg-[#E8E8E8] cursor-pointer hover:bg-gray-300'>
                  <div className='w-6 h-6 mb-1'>
                    ...
                    >
                      <path
                        d='M12 1L15.09 8.26L23 9L17 14.74L18.18 22.02L12 19L5.82 22.02L7 14.74L1 9L8.91 8.26L12 1Z'
                        fill='#6B7280'
                      />
                    </svg>
                  </div>
          ...
          <div className='w-full h-[79px] flex flex-col items-center justify-center bg-[#52baf3]'>
            <div className='w-6 h-6 mb-1'>
              ...
              >
                ...
                />
                <path
                  d='M19 15L19.74 17.74L22 18L19.74 18.26L19 21L18.26 18.26L16 18L18.26 17.74L19 15Z'
                  fill='white'
                />
                <path
          ...
          <div className='p-6'>
                        ...
                        >
                          {columns.map(function (column) {
                            return (
                              <TableCell
                                key={column.key}
                                className='text-[#4f5863] text-[13px] font-normal py-3'
                              >
                                {column.render
                                  ? column.render(item)
                                  : item[column.key]}
            ...
            <div className="mt-4 text-xs font-normal font-['Mulish',Helvetica] text-black">
              {filteredData.length > 0
                ? '1 to '
                    .concat(filteredData.length, ' of ')
                    .concat(filteredData.length)
                : '0 to 0 of 0'}
            </div>
          </div>
        </main>
