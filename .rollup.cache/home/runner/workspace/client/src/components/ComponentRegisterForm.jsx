...
var getComponentMockData = function (code) {
    ...
    var getComponentDetails = function (code) {
        ...
        var serialNo = "SN-".concat(new Date().getFullYear(), "-").concat(code.replace(/\./g, ''), "-").concat(Math.floor(Math.random() * 9999)
            .toString()
            .padStart(4, '0'));
        ...
        return {
            ...
            parentComponent: levels.length > 1
                ? "Level ".concat(levels.slice(0, -1).join('.'))
                : 'Ship Structure',
            dimensionsSize: levels.length === 4
                ? '0.5m x 0.3m'
                : levels.length === 3
                    ? '2m x 1m'
                    : '5m x 3m',
...
var ComponentRegisterForm = function (_a) {
    ...
    var sessionModifiedFields = useState(new Set())[0];
    ...
    var _l = useState(null), editingLabel = _l[0], setEditingLabel = _l[1];
    var _m = useState(new Set()), deletedFields = _m[0], setDeletedFields = _m[1];
    var _o = useState(null), showDeleteConfirm = _o[0], setShowDeleteConfirm = _o[1];
    var _p = useState({
        maker: 'Maker',
        model: 'Model',
        serialNo: 'Serial No',
    ...
    }), fieldLabels = _p[0], setFieldLabels = _p[1];
    var _q = useState({
    ...
    }), componentData = _q[0], setComponentData = _q[1];
    ...
    var handleInputChange = function (field, value) {
        if (field.includes('.')) {
            ...
            setComponentData(function (prev) {
                ...
                return __assign(__assign({}, prev), (_a = {}, _a[parent_1] = __assign(__assign({}, (typeof parentValue === 'object' && parentValue !== null
                    ? parentValue
                    : {})), (_b = {}, _b[child_1] = value, _b)), _a));
            });
        }
        else {
            setComponentData(function (prev) {
      ...
      <DialogContent className='w-[95vw] max-w-none h-[95vh] flex flex-col'>
        ...
        <div className='flex flex-1 overflow-hidden'>
          ...
          <div className='flex-1 overflow-auto p-6'>
              ...
              <div className='bg-gray-50 px-6 py-4 border-b border-gray-200'>
                <div className='flex items-center justify-between'>
                  <div className='flex-1'>
                    <Input value={componentData.componentName || ''} onChange={function (e) {
            return handleInputChange('componentName', e.target.value);
        }} placeholder='Component Name (required)' className='text-lg font-semibold mb-1' required/>
            ...
            : ''} readOnly className='border-gray-300 bg-gray-50' title="Component Category is derived from the component's tree position"/>
                    </div>
                    <div className='space-y-2'>
            ...
            return handleInputChange('location', e.target.value);
                    ...
                    <div className='space-y-2'>
                      ...
                      <Input value={componentData.critical} onChange={function (e) {
            return handleInputChange('critical', e.target.value);
        }} className='border-[#52baf3] border-2 focus:border-[#52baf3]'/>
                    </div>
                    <div className='space-y-2'>
                      <EditableLabel fieldKey='installation'/>
                      <Input value={componentData.installation} onChange={function (e) {
            return handleInputChange('installation', e.target.value);
        }} className='border-[#52baf3] border-2 focus:border-[#52baf3]'/>
                    </div>
                    <div className='space-y-2'>
                      <EditableLabel fieldKey='commissionedDate'/>
                      <Input value={componentData.commissionedDate} onChange={function (e) {
            return handleInputChange('commissionedDate', e.target.value);
        }} className='border-[#52baf3] border-2 focus:border-[#52baf3]'/>
                    </div>
                    <div className='space-y-2'>
            ...
            return handleInputChange('rating', e.target.value);
                    ...
                    <div className='space-y-2'>
                      ...
                      <Input value={componentData.conditionBased} onChange={function (e) {
            return handleInputChange('conditionBased', e.target.value);
        }} className='border-[#52baf3] border-2 focus:border-[#52baf3]'/>
                    </div>
            ...
            return handleInputChange('equipmentDepartment', e.target.value);
        }} className='border-[#52baf3] border-2 focus:border-[#52baf3]'/>
                    </DeletableField>
            ...
            return handleInputChange('parentComponent', e.target.value);
        }} className='border-[#52baf3] border-2 focus:border-[#52baf3]'/>
                    </DeletableField>
            ...
            return handleInputChange('dimensionsSize', e.target.value);
        }} className='border-[#52baf3] border-2 focus:border-[#52baf3]'/>
                    </DeletableField>
                  </div>
                  <div className='mt-4'>
        ...
        }} placeholder='Notes' className='border-[#52baf3] border-2 focus:border-[#52baf3]' rows={2}/>
                    </DeletableField>
                  </div>
                ...
                setShowAddFieldModal(true);
                  ...
                  <div className='grid grid-cols-2 gap-6 mb-4'>
                    <DeletableField fieldKey='runningHours'>
                      ...
                      <Input value={componentData.runningHours} onChange={function (e) {
            return handleInputChange('runningHours', e.target.value);
        }} placeholder='20000' className='border-[#52baf3] border-2 focus:border-[#52baf3]'/>
                    </DeletableField>
                    <DeletableField fieldKey='dateUpdated'>
                      <EditableLabel fieldKey='dateUpdated'/>
                      <Input value={componentData.dateUpdated} onChange={function (e) {
            return handleInputChange('dateUpdated', e.target.value);
        }} placeholder='dd-mm-yyyy' className='border-[#52baf3] border-2 focus:border-[#52baf3]'/>
                    </DeletableField>
                  </div>
                  <div className='space-y-4'>
                    ...
                    <div className='grid grid-cols-2 gap-6'>
                      <DeletableField fieldKey='metric'>
                        ...
                        <Input value={componentData.metric} onChange={function (e) {
            return handleInputChange('metric', e.target.value);
                      ...
                      <DeletableField fieldKey='alertsThresholds'>
                        ...
                        <Input value={componentData.alertsThresholds} onChange={function (e) {
            return handleInputChange('alertsThresholds', e.target.value);
        }} className='border-[#52baf3] border-2 focus:border-[#52baf3]'/>
                      </DeletableField>
                    </div>
                  </div>
                  ...
                  <div className='border border-gray-200 rounded'>
                    ...
                    {isAddMode ? (<div className='px-4 py-8 text-center text-sm text-gray-500'>
                        ...
                        <div className='grid grid-cols-5 gap-4 text-sm items-center'>
                          <div>
                            <Input value={componentData.workOrderNo} onChange={function (e) {
                return handleInputChange('workOrderNo', e.target.value);
            }} className='border-[#52baf3] border-2 focus:border-[#52baf3] text-sm'/>
                          </div>
                          <div>
                            <Input value={componentData.performedBy} onChange={function (e) {
                return handleInputChange('performedBy', e.target.value);
            }} className='border-[#52baf3] border-2 focus:border-[#52baf3] text-sm'/>
                          </div>
                          <div>
                            <Input value={componentData.totalTimeHrs} onChange={function (e) {
                return handleInputChange('totalTimeHrs', e.target.value);
            }} className='border-[#52baf3] border-2 focus:border-[#52baf3] text-sm'/>
                          </div>
                          <div>
                            <Input value={componentData.completionDate} onChange={function (e) {
                return handleInputChange('completionDate', e.target.value);
            }} className='border-[#52baf3] border-2 focus:border-[#52baf3] text-sm'/>
                          </div>
                          <div>
                            <Input value={componentData.status} onChange={function (e) {
                ...
                <div>
                  ...
                  <div className='border border-gray-200 rounded'>
                    ...
                    <div className='px-4 py-3'>
                      <div className='grid grid-cols-5 gap-4 text-sm items-center'>
                        <div>
                          <Input value={componentData.partCode} onChange={function (e) {
            return handleInputChange('partCode', e.target.value);
        }} className='border-[#52baf3] border-2 focus:border-[#52baf3] text-sm'/>
                        </div>
                        <div>
                          <Input value={componentData.partName} onChange={function (e) {
            return handleInputChange('partName', e.target.value);
        }} className='border-[#52baf3] border-2 focus:border-[#52baf3] text-sm'/>
                        </div>
                        <div>
                          <Input value={componentData.minQty} onChange={function (e) {
            return handleInputChange('minQty', e.target.value);
        }} className='border-[#52baf3] border-2 focus:border-[#52baf3] text-sm'/>
                        </div>
                        <div>
                          <Input value={componentData.criticalQty} onChange={function (e) {
            return handleInputChange('criticalQty', e.target.value);
        }} className='border-[#52baf3] border-2 focus:border-[#52baf3] text-sm'/>
                        </div>
                        <div>
                          <Input value={componentData.locationStore} onChange={function (e) {
            return handleInputChange('locationStore', e.target.value);
        }} className='border-[#52baf3] border-2 focus:border-[#52baf3] text-sm'/>
                        </div>
                      </div>
                    </div>
                ...
                <div>
                  ...
                  <div className='grid grid-cols-2 gap-6'>
                    <DeletableField fieldKey='classificationProvider'>
                      ...
                      <Input value={componentData.classificationData
            .classificationProvider} onChange={function (e) {
            return handleInputChange('classificationData.classificationProvider', e.target.value);
        }} className='border-[#52baf3] border-2 focus:border-[#52baf3]'/>
                    </DeletableField>
                    <DeletableField fieldKey='certificateNo'>
                      <EditableLabel fieldKey='certificateNo'/>
                      <Input value={componentData.classificationData.certificateNo} onChange={function (e) {
            return handleInputChange('classificationData.certificateNo', e.target.value);
        }} className='border-[#52baf3] border-2 focus:border-[#52baf3]'/>
                    </DeletableField>
                    <DeletableField fieldKey='lastDataSurvey'>
                      <EditableLabel fieldKey='lastDataSurvey'/>
                      <Input value={componentData.classificationData.lastDataSurvey} onChange={function (e) {
            return handleInputChange('classificationData.lastDataSurvey', e.target.value);
        }} className='border-[#52baf3] border-2 focus:border-[#52baf3]'/>
                    </DeletableField>
                    <DeletableField fieldKey='nextDataSurvey'>
                      <EditableLabel fieldKey='nextDataSurvey'/>
                      <Input value={componentData.classificationData.nextDataSurvey} onChange={function (e) {
            return handleInputChange('classificationData.nextDataSurvey', e.target.value);
        }} className='border-[#52baf3] border-2 focus:border-[#52baf3]'/>
                    </DeletableField>
                    <DeletableField fieldKey='surveyType'>
                      <EditableLabel fieldKey='surveyType'/>
                      <Input value={componentData.classificationData.surveyType} onChange={function (e) {
            return handleInputChange('classificationData.surveyType', e.target.value);
        }} className='border-[#52baf3] border-2 focus:border-[#52baf3]'/>
                    </DeletableField>
                    <DeletableField fieldKey='classRequirements'>
                      <EditableLabel fieldKey='classRequirements'/>
                      <Input value={componentData.classificationData.classRequirements} onChange={function (e) {
            return handleInputChange('classificationData.classRequirements', e.target.value);
        }} className='border-[#52baf3] border-2 focus:border-[#52baf3]'/>
                    </DeletableField>
                    <DeletableField fieldKey='classCode'>
                      <EditableLabel fieldKey='classCode'/>
                      <Input value={componentData.classificationData.classCode} onChange={function (e) {
            return handleInputChange('classificationData.classCode', e.target.value);
        }} className='border-[#52baf3] border-2 focus:border-[#52baf3]'/>
                    </DeletableField>
                    <DeletableField fieldKey='information'>
                      <EditableLabel fieldKey='information'/>
                      <Input value={componentData.classificationData.information} onChange={function (e) {
            return handleInputChange('classificationData.information', e.target.value);
        }} className='border-[#52baf3] border-2 focus:border-[#52baf3]'/>
                    </DeletableField>
                  </div>
                </div>
                ...
                setShowAddFieldModal(true);
                  ...
                  <div className='border border-gray-200 rounded'>
                    ...
                    <div className='px-4 py-3'>
                      <div className='grid grid-cols-5 gap-4 text-sm items-center'>
                        <div>
                          <Input value={componentData.reqNo} onChange={function (e) {
            return handleInputChange('reqNo', e.target.value);
        }} className='border-[#52baf3] border-2 focus:border-[#52baf3] text-sm'/>
                        </div>
                        <div>
                          <Input value={componentData.reqPart} onChange={function (e) {
            return handleInputChange('reqPart', e.target.value);
        }} className='border-[#52baf3] border-2 focus:border-[#52baf3] text-sm'/>
                        </div>
                        <div>
                          <Input value={componentData.reqQty} onChange={function (e) {
            return handleInputChange('reqQty', e.target.value);
        }} className='border-[#52baf3] border-2 focus:border-[#52baf3] text-sm'/>
                        </div>
                        <div>
                          <Input value={componentData.reqDate} onChange={function (e) {
            return handleInputChange('reqDate', e.target.value);
        }} className='border-[#52baf3] border-2 focus:border-[#52baf3] text-sm'/>
                        </div>
                        <div>
                          <Input value={componentData.reqStatus} onChange={function (e) {
            return handleInputChange('reqStatus', e.target.value);
        }} className='border-[#52baf3] border-2 focus:border-[#52baf3] text-sm'/>
                        </div>
                      </div>
                    </div>
            ...
            return (<div key={section.id}>
                    ...
                    <div className='grid grid-cols-3 gap-4'>
                      {(_a = section.fields) === null || _a === void 0 ? void 0 : _a.map(function (field) {
                    return renderCustomField(field);
                })}
                      {(_b = customFields[section.id]) === null || _b === void 0 ? void 0 : _b.map(function (field) {
                    return renderCustomField(field);
                })}
                    </div>
                  </div>);
