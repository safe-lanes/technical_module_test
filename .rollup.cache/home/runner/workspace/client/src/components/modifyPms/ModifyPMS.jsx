...
export function ModifyPMS() {
  ...
  var _a = useState('all'),
    categoryFilter = _a[0],
    setCategoryFilter = _a[1];
  var _b = useState(''),
    searchQuery = _b[0],
    setSearchQuery = _b[1];
  var _c = useState(false),
    isNewRequestModalOpen = _c[0],
    setIsNewRequestModalOpen = _c[1];
  var _d = useState(null),
    viewingRequest = _d[0],
    setViewingRequest = _d[1];
  var _e = useLocation(),
    location = _e[0],
    setLocation = _e[1];
        ...
        return __generator(this, function (_c) {
          switch (_c.label) {
            case 0:
              return [
                4 /*yield*/,
                fetch('/api/change-requests/'.concat(id, '/approve'), {
                  method: 'PUT',
    ...
    onMutate: function (_a) {
      return __awaiter(_this, [_a], void 0, function (_b) {
        ...
        return __generator(this, function (_c) {
          ...
          if (viewingRequest) {
            setViewingRequest(
              __assign(__assign({}, viewingRequest), { status: 'approved' })
            );
          }
          return [2 /*return*/];
        });
        ...
        return __generator(this, function (_c) {
          switch (_c.label) {
            case 0:
              return [
                4 /*yield*/,
                fetch('/api/change-requests/'.concat(id, '/reject'), {
                  method: 'PUT',
                  headers: { 'Content-Type': 'application/json' },
                  body: JSON.stringify({
                    comment: comment,
    ...
    onMutate: function (_a) {
      return __awaiter(_this, [_a], void 0, function (_b) {
        ...
        return __generator(this, function (_c) {
          ...
          if (viewingRequest) {
            setViewingRequest(
              __assign(__assign({}, viewingRequest), { status: 'rejected' })
            );
          }
          return [2 /*return*/];
        });
              ...
              {isLoading ? (
                ...
                <div className='h-full flex flex-col'>
                  ...
                  <div className='mt-auto px-6 py-4 border-t border-gray-200 text-sm text-gray-500'>
                    {filteredRequests.length > 0
                      ? '0 to '
                          .concat(filteredRequests.length, ' of ')
                          .concat(filteredRequests.length)
                      : '0 to 0 of 0'}
                  </div>
                </div>
              )}
              ...
              <Button
                ...
                onClick={function () {
                  if (viewingRequest) {
                    ...
                    setLocation(
                      ''.concat(targetPath, '?').concat(params.toString())
                    );
                    setViewingRequest(null);
                  }
                }}
