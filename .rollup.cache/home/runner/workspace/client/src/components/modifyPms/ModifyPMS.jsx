        ...
        onSuccess: function (updatedRequest) {
            ...
            if (viewingRequest) {
                queryClient.invalidateQueries({
                    queryKey: ["/api/change-requests/".concat(viewingRequest.id)],
                });
            }
          ...
          <div className='flex-1 p-6'>
            <div className='bg-white rounded-lg border border-gray-200 h-full'>
              {isLoading ? (<div className='text-center py-12 text-gray-500'>
                  Loading...
                </div>) : filteredRequests.length === 0 ? (<div className='text-center py-12 text-gray-500'>
                ...
                ? "0 to ".concat(filteredRequests.length, " of ").concat(filteredRequests.length)
                : '0 to 0 of 0'}
                  </div>
                </div>)}
            </div>
          ...
          {viewingRequest && (<div className='space-y-6'>
              ...
              <div className='grid grid-cols-2 gap-4'>
                ...
                <div>
                  ...
                  <div className='mt-1'>
                    {viewingRequest.status === 'submitted' && (<Badge className='bg-[#52BAF3] text-white'>
                        Pending Approval
                      </Badge>)}
                    {viewingRequest.status === 'approved' && (<Badge className='bg-green-500 text-white'>
                        Approved
                      </Badge>)}
              ...
              {viewingRequest.proposedChangesJson &&
                ...
                viewingRequest.proposedChangesJson.length > 0 && (<div>
                    <Label className='text-sm font-medium text-gray-500'>
                      Proposed Changes
                    </Label>
