...
export var AuthProvider = function (_a) {
    ...
    var hasPermission = function (permission) {
        var _a;
        return (_a = user === null || user === void 0 ? void 0 : user.permissions.includes(permission)) !== null && _a !== void 0 ? _a : false;
    };
...
export var withAuth = function (WrappedComponent, requiredPermissions, requiredRoles) {
    return function AuthenticatedComponent(props) {
        var _a = useAuth(), isAuthenticated = _a.isAuthenticated, hasAnyPermission = _a.hasAnyPermission, hasRole = _a.hasRole, isLoading = _a.isLoading, user = _a.user;
        if (isLoading) {
        ...
        if (requiredRoles && !requiredRoles.some(function (role) { return hasRole(role); })) {
            return (<div className='flex items-center justify-center min-h-screen'>
          <div className='text-lg text-red-600'>
