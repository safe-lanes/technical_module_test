...
export var getFormSectionClasses = function () { return ({
    container: 'bg-white',
    content: 'p-6',
    header: 'pb-4 mb-6',
...
export var getTableClasses = function () { return ({
...
export var getButtonClasses = function () { return ({
...
export var getStepperClasses = function () { return ({
