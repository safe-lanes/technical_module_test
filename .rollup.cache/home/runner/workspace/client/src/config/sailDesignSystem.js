...
export var getFormSectionClasses = function () {
  return {
    container: 'bg-white',
    content: 'p-6',
    header: 'pb-4 mb-6',
...
export var getTableClasses = function () {
  return {
...
export var getButtonClasses = function () {
  return {
...
export var getStepperClasses = function () {
  return {
    sidebar: 'hidden lg:block w-72 overflow-y-auto bg-[#f8fafc]',
    nav: 'p-6',
    item: 'relative',
    button:
      'w-full flex items-center p-3 rounded-lg text-left transition-colors hover:bg-gray-50',
    activeButton: 'bg-blue-50',
    circle:
      'w-10 h-10 rounded-full flex items-center justify-center text-white font-semibold mr-4',
...
//# sourceMappingURL=sailDesignSystem.js.map
