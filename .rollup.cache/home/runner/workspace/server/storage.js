...
var MemStorage = /** @class */ (function () {
    ...
    MemStorage.prototype.generateComponentSpareCode = function (vesselId, componentCode) {
        ...
        var existingSpares = Array.from(this.spares.values())
            .filter(function (s) { return s.vesselId === vesselId && s.componentCode === componentCode && s.componentSpareCode; })
    ...
    MemStorage.prototype.getSpares = function (vesselId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, Array.from(this.spares.values())
                        .filter(function (s) { return s.vesselId === vesselId && !s.deleted; })];
            });
        });
    };
    ...
    MemStorage.prototype.getAlertDeliveries = function (eventId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, Array.from(this.alertDeliveries.values())
                        .filter(function (d) { return d.eventId === eventId; })];
            });
        });
    };
