...
var MemStorage = /** @class */ (function () {
  ...
  MemStorage.prototype.initializeComponents = function () {
    ...
    sampleComponents.forEach(function (comp) {
      return _this.components.set(comp.id, comp);
    });
  };
  ...
  MemStorage.prototype.getUserByUsername = function (username) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        return [
          2 /*return*/,
          Array.from(this.users.values()).find(function (user) {
  ...
  MemStorage.prototype.getComponents = function (vesselId) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        return [
          2 /*return*/,
          Array.from(this.components.values()).filter(function (c) {
            return c.vesselId === vesselId;
          }),
        ];
      });
    });
  ...
  MemStorage.prototype.createRunningHoursAudit = function (audit) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_c) {
        ...
        fullAudit = __assign(__assign({}, audit), {
          id: id,
          previousRH: audit.previousRH.toString(),
          newRH: audit.newRH.toString(),
          cumulativeRH: audit.cumulativeRH.toString(),
          oldMeterFinal:
            ((_a = audit.oldMeterFinal) === null || _a === void 0
              ? void 0
              : _a.toString()) || null,
          newMeterStart:
            ((_b = audit.newMeterStart) === null || _b === void 0
              ? void 0
              : _b.toString()) || null,
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        audits = this.runningHoursAudits
          ...
          .sort(function (a, b) {
            return b.enteredAtUTC.getTime() - a.enteredAtUTC.getTime();
          });
        return [2 /*return*/, limit ? audits.slice(0, limit) : audits];
      });
    });
  };
  MemStorage.prototype.getRunningHoursAuditsInDateRange = function (
    componentId,
    startDate,
    endDate
  ) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        return [
          2 /*return*/,
          this.runningHoursAudits.filter(function (a) {
  ...
  MemStorage.prototype.generateComponentSpareCode = function (
    vesselId,
    componentCode
  ) {
    ...
    var nextNumber =
      existingNumbers.length > 0
        ? Math.max.apply(Math, existingNumbers) + 1
        : 1;
  ...
  MemStorage.prototype.initializeSpares = function () {
    ...
    sampleSpares.forEach(function (spare) {
      return _this.spares.set(spare.id, spare);
    });
  ...
  MemStorage.prototype.getSpares = function (vesselId) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        return [
          2 /*return*/,
          Array.from(this.spares.values()).filter(function (s) {
            return s.vesselId === vesselId && !s.deleted;
          }),
        ];
      });
    });
          ...
          case 0:
            ...
            componentSpareCode =
              ...
              (spare.componentCode
                ...
                : null);
            newSpare = __assign(__assign({}, spare), {
              id: id,
  ...
  MemStorage.prototype.consumeSpare = function (
    id,
    quantity,
    userId,
    remarks,
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.getSpare(id)];
          case 1:
            spare = _a.sent();
            if (!spare) {
              throw new Error('Spare '.concat(id, ' not found'));
  ...
  MemStorage.prototype.receiveSpare = function (
    id,
    quantity,
    userId,
    remarks,
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            spare = _a.sent();
            if (!spare) return [3 /*break*/, 4];
            netChange = 0;
            if (update.consumed) {
              if (spare.rob < update.consumed) {
                throw new Error(
                  'Insufficient stock for '.concat(spare.partCode)
                );
              }
    ...
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        return [
          ...
          this.sparesHistory
            .filter(function (h) {
              return h.vesselId === vesselId;
            })
            .sort(function (a, b) {
              return b.timestampUTC.getTime() - a.timestampUTC.getTime();
            }),
        ];
      });
    });
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        ...
        if (filters) {
          ...
          if (filters.vesselId) {
            requests = requests.filter(function (r) {
              return r.vesselId === filters.vesselId;
            });
          }
          if (filters.q) {
            ...
            requests = requests.filter(function (r) {
              return (
                r.title.toLowerCase().includes(search_1) ||
  ...
  MemStorage.prototype.createChangeRequest = function (request) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        ...
        now = new Date();
        fullRequest = __assign(__assign({}, request), {
          id: id,
  ...
  MemStorage.prototype.updateChangeRequest = function (id, data) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        ...
        updated = __assign(__assign(__assign({}, request), data), {
          updatedAt: new Date(),
        });
  ...
  MemStorage.prototype.updateChangeRequestTarget = function (
    id,
    targetType,
    targetId,
    snapshotBeforeJson
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        ...
        if (request.status !== 'draft' && request.status !== 'returned') {
          throw new Error(
            'Can only update target for draft or returned requests'
          );
        }
        updated = __assign(__assign({}, request), {
  ...
  MemStorage.prototype.updateChangeRequestProposed = function (
    id,
    proposedChangesJson,
    movePreviewJson
  ) {
  ...
  MemStorage.prototype.approveChangeRequest = function (
    id,
    reviewerId,
    comment
  ) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.createChangeRequestComment({
                changeRequestId: id,
                userId: reviewerId,
  ...
  MemStorage.prototype.rejectChangeRequest = function (
    id,
    reviewerId,
    comment
  ) {
  ...
  MemStorage.prototype.returnChangeRequest = function (
    id,
    reviewerId,
    comment
  ) {
  ...
  MemStorage.prototype.getChangeRequestAttachments = function (
    changeRequestId
  ) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        return [
          2 /*return*/,
          this.changeRequestAttachments.filter(function (a) {
            return a.changeRequestId === changeRequestId;
          }),
        ];
      });
    });
  ...
  MemStorage.prototype.createChangeRequestAttachment = function (attachment) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        ...
        fullAttachment = __assign(__assign({}, attachment), {
          id: id,
          uploadedAt: new Date(),
        });
    ...
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        return [
          ...
          this.changeRequestComments
            .filter(function (c) {
              return c.changeRequestId === changeRequestId;
            })
            .sort(function (a, b) {
              return b.createdAt.getTime() - a.createdAt.getTime();
            }),
  ...
  MemStorage.prototype.createChangeRequestComment = function (comment) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        ...
        fullComment = __assign(__assign({}, comment), {
          id: id,
          createdAt: new Date(),
        });
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        ...
        for (
          ...
          newComp = __assign(__assign({}, comp), {
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        ...
        _loop_1 = function (robId, data) {
          // Find spare by robId
          var existingEntry = Array.from(this_1.spares.entries()).find(
            function (_a) {
              var _ = _a[0],
                spare = _a[1];
          ...
          if (existingEntry) {
            var id = existingEntry[0],
              existing = existingEntry[1];
            var updatedSpare = __assign(
              __assign(__assign({}, existing), data),
              { updatedAt: new Date() }
            );
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        ...
        _loop_2 = function (spare) {
          ...
          var existingEntry = Array.from(this_2.spares.entries()).find(
            function (_a) {
              var _ = _a[0],
                s = _a[1];
          ...
          if (existingEntry) {
            var id = existingEntry[0],
              existing = existingEntry[1];
            var updatedSpare = __assign(
              __assign(__assign({}, existing), spare),
              {
                stockStatus: this_2.calculateStockStatus(
            ...
            var newSpare = __assign(__assign({}, spare), {
              id: id,
              robStock: spare.robStock || 0,
              consumed: spare.consumed || 0,
              received: spare.received || 0,
      ...
      return __generator(this, function (_a) {
        ...
        for (_i = 0, ids_1 = ids; _i < ids_1.length; _i++) {
          ...
          if (this.components.has(id)) {
            ...
            this.components.set(
              id,
              __assign(__assign({}, comp), { status: 'archived' })
            );
            archived++;
          }
        }
      ...
      return __generator(this, function (_a) {
        ...
        for (_i = 0, ids_2 = ids; _i < ids_2.length; _i++) {
          ...
          if (this.spares.has(id)) {
            ...
            this.spares.set(
              id,
              __assign(__assign({}, spare), { status: 'archived' })
            );
            archived++;
          }
        }
  ...
  MemStorage.prototype.initializeAlertPolicies = function () {
    ...
    defaultPolicies.forEach(function (policy, index) {
      var newPolicy = __assign(__assign({ id: index + 1 }, policy), {
        createdAt: new Date(),
        updatedAt: new Date(),
      });
  ...
  MemStorage.prototype.createAlertPolicy = function (policy) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        newPolicy = __assign(
          __assign({ id: this.currentAlertPolicyId++ }, policy),
  ...
  MemStorage.prototype.updateAlertPolicy = function (id, data) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        ...
        updated = __assign(__assign(__assign({}, policy), data), {
          updatedAt: new Date(),
        });
        ...
        if (filters) {
          if (filters.startDate) {
            events = events.filter(function (e) {
              return e.createdAt >= filters.startDate;
            });
          }
          if (filters.endDate) {
            events = events.filter(function (e) {
              return e.createdAt <= filters.endDate;
            });
          }
          if (filters.alertType) {
            events = events.filter(function (e) {
              return e.alertType === filters.alertType;
            });
          }
          if (filters.priority) {
            events = events.filter(function (e) {
              return e.priority === filters.priority;
            });
          }
          if (filters.vesselId) {
            events = events.filter(function (e) {
              return e.vesselId === filters.vesselId;
            });
          }
        }
        return [
  ...
  MemStorage.prototype.createAlertEvent = function (event) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        newEvent = __assign(
          __assign({ id: this.currentAlertEventId++ }, event),
          { createdAt: new Date() }
        );
  ...
  MemStorage.prototype.acknowledgeAlertEvent = function (id, userId) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        ...
        updated = __assign(__assign({}, event), {
          ackBy: userId,
          ackAt: new Date(),
        });
  ...
  MemStorage.prototype.getAlertDeliveries = function (eventId) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        return [
          2 /*return*/,
          Array.from(this.alertDeliveries.values()).filter(function (d) {
  ...
  MemStorage.prototype.createAlertDelivery = function (delivery) {
    return __awaiter(this, void 0, void 0, function () {
      var newDelivery;
      return __generator(this, function (_a) {
        newDelivery = __assign(
          __assign({ id: this.currentAlertDeliveryId++ }, delivery),
          { createdAt: new Date() }
        );
  ...
  MemStorage.prototype.updateAlertDeliveryStatus = function (
    id,
    status,
    errorMessage
  ) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        ...
        updated = __assign(__assign({}, delivery), {
          status: status,
  ...
  MemStorage.prototype.createOrUpdateAlertConfig = function (config) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        ...
        if (existing) {
          updated = __assign(__assign(__assign({}, existing), config), {
            updatedAt: new Date(),
          });
          ...
          newConfig = __assign(
            __assign({ id: this.currentAlertConfigId++ }, config),
            { createdAt: new Date(), updatedAt: new Date() }
          );
  ...
  MemStorage.prototype.getFormDefinitionByName = function (name) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        return [
          2 /*return*/,
          Array.from(this.formDefinitions.values()).find(function (f) {
            return f.name === name;
          }),
        ];
      });
  ...
  MemStorage.prototype.getFormVersions = function (formId) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        return [
          2 /*return*/,
          Array.from(this.formVersions.values())
            .filter(function (v) {
  ...
  MemStorage.prototype.getLatestPublishedVersion = function (formId) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.getFormVersions(formId)];
          case 1:
            versions = _a.sent();
            return [
              2 /*return*/,
  ...
  MemStorage.prototype.getLatestPublishedVersionByName = function (name) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.getFormDefinitionByName(name)];
          case 1:
            form = _a.sent();
            if (!form) return [2 /*return*/, undefined];
  ...
  MemStorage.prototype.createFormVersion = function (version) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        newVersion = __assign(
          __assign({ id: this.currentFormVersionId++ }, version),
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.getLatestPublishedVersion(version.formId),
            ];
          case 1:
            currentPublished = _a.sent();
            if (currentPublished) {
              this.formVersions.set(
                currentPublished.id,
                __assign(__assign({}, currentPublished), { status: 'ARCHIVED' })
              );
            }
            published = __assign(__assign({}, version), {
              status: 'PUBLISHED',
              authorUserId: userId,
              changelog: changelog,
              versionDate: new Date(),
  ...
  MemStorage.prototype.createFormVersionUsage = function (usage) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        newUsage = __assign(
          __assign({ id: this.currentFormUsageId++ }, usage),
  ...
  MemStorage.prototype.getFormVersionUsage = function (formVersionId) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        return [
          2 /*return*/,
          this.formVersionUsages.filter(function (u) {
            return u.formVersionId === formVersionId;
          }),
        ];
      });
    });
