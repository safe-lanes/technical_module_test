        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, storage.getChangeRequests({
                            vesselId: vesselId,
                        })];
                case 1:
                    requests = _b.sent();
            ...
            switch (_a.label) {
                ...
                case 2:
                    ...
                    if (error_3 instanceof z.ZodError) {
                        return [2 /*return*/, res
                                .status(400)
                                .json({ error: 'Validation failed', details: error_3.errors })];
                    }
            ...
            switch (_a.label) {
                ...
                case 2:
                    ...
                    if (error_6 instanceof z.ZodError) {
                        return [2 /*return*/, res
                                .status(400)
                                .json({ error: 'Validation failed', details: error_6.errors })];
                    }
            ...
            switch (_a.label) {
                ...
                case 2:
                    ...
                    if (error_8 instanceof z.ZodError) {
                        return [2 /*return*/, res
                                .status(400)
                                .json({ error: 'Validation failed', details: error_8.errors })];
                    }
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    res
                        .status(500)
                        .json({ error: error_9.message || 'Failed to approve change request' });
                    return [3 /*break*/, 3];
                case 3: return [2 /*return*/];
            }
        });
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    res
                        .status(500)
                        .json({ error: error_10.message || 'Failed to reject change request' });
                    return [3 /*break*/, 3];
                case 3: return [2 /*return*/];
            }
        });
