...
export default function createChangeRequestsRouter(storage) {
    ...
    router.get("/", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    _a = req.query, vesselId = _a.vesselId, status_1 = _a.status, category_1 = _a.category, requestedBy_1 = _a.requestedBy;
                    return [4 /*yield*/, storage.getChangeRequests({ vesselId: vesselId })];
                case 1:
                    requests = _b.sent();
                    // Apply filters
                    if (status_1) {
                        requests = requests.filter(function (r) { return r.status === status_1; });
                    }
                    if (category_1) {
                        requests = requests.filter(function (r) { return r.category === category_1; });
                    }
                    if (requestedBy_1) {
                        requests = requests.filter(function (r) { return r.requestedByUserId === requestedBy_1; });
                    }
                    // Sort by most recent first
                    requests.sort(function (a, b) { return b.createdAt.getTime() - a.createdAt.getTime(); });
                    res.json(requests);
                    return [3 /*break*/, 3];
                case 2:
                    error_1 = _b.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    requestData = __assign(__assign({}, validatedData), { vesselId: validatedData.vesselId || 'V001', status: validatedData.status || 'draft', requestedByUserId: validatedData.requestedByUserId || 'system' });
                ...
                case 2:
                    ...
                    if (error_3 instanceof z.ZodError) {
                        return [2 /*return*/, res.status(400).json({ error: "Validation failed", details: error_3.errors })];
                    }
    ...
    router.patch("/:id/status", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        var id, _a, status_2, reviewedByUserId, reviewComments, updatedRequest, error_4;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    id = parseInt(req.params.id);
                    _a = req.body, status_2 = _a.status, reviewedByUserId = _a.reviewedByUserId, reviewComments = _a.reviewComments;
                    if (!['draft', 'submitted', 'returned', 'approved', 'rejected'].includes(status_2)) {
    ...
    router.get("/:id/comments", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, storage.getChangeRequestComments(changeRequestId)];
                case 1:
                    comments = _a.sent();
                    res.json(comments);
                    return [3 /*break*/, 3];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    changeRequestId = parseInt(req.params.id);
                    commentData = __assign(__assign({}, req.body), { changeRequestId: changeRequestId });
                    validatedData = insertChangeRequestCommentSchema.parse(commentData);
                    return [4 /*yield*/, storage.createChangeRequestComment(validatedData)];
                case 1:
                    newComment = _a.sent();
                ...
                case 2:
                    ...
                    if (error_6 instanceof z.ZodError) {
                        return [2 /*return*/, res.status(400).json({ error: "Validation failed", details: error_6.errors })];
                    }
    ...
    router.get("/:id/attachments", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    changeRequestId = parseInt(req.params.id);
                    return [4 /*yield*/, storage.getChangeRequestAttachments(changeRequestId)];
                case 1:
                    attachments = _a.sent();
    ...
    router.post("/:id/attachments", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        var changeRequestId, attachmentData, validatedData, newAttachment, error_8;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    changeRequestId = parseInt(req.params.id);
                    attachmentData = __assign(__assign({}, req.body), { changeRequestId: changeRequestId });
                    validatedData = insertChangeRequestAttachmentSchema.parse(attachmentData);
                    return [4 /*yield*/, storage.createChangeRequestAttachment(validatedData)];
                case 1:
                ...
                case 2:
                    ...
                    if (error_8 instanceof z.ZodError) {
                        return [2 /*return*/, res.status(400).json({ error: "Validation failed", details: error_8.errors })];
                    }
    ...
    router.put("/:id/approve", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    res.status(500).json({ error: error_9.message || 'Failed to approve change request' });
                    return [3 /*break*/, 3];
                case 3: return [2 /*return*/];
            }
        });
    ...
    router.put("/:id/reject", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    res.status(500).json({ error: error_10.message || 'Failed to reject change request' });
                    return [3 /*break*/, 3];
                case 3: return [2 /*return*/];
            }
        });
