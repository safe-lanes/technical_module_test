      ...
      switch (_a.label) {
        ...
        case 1:
          ...
          if (!policy) {
            return [
              2 /*return*/,
              res.status(404).json({ error: 'Alert policy not found' }),
            ];
          }
          res.json(policy);
          return [3 /*break*/, 3];
...
// Update alert policy
router.patch('/policies/:id', function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
...
router.post('/policies/batch-update', function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 5:
          ...
          res
            .status(500)
            .json({ error: 'Failed to batch update alert policies' });
          return [3 /*break*/, 6];
        case 6:
          return [2 /*return*/];
      }
...
router.post('/events/:id/acknowledge', function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
...
router.get('/config/:vesselId', function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    var config, error_9;
    return __generator(this, function (_a) {
      switch (_a.label) {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            storage.createOrUpdateAlertConfig(
              __assign(__assign({}, req.body), {
