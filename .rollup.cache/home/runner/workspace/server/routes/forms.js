...
router.post('/admin/forms/seed-from-live', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var error_1;
...
router.get('/admin/forms', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                forms = _a.sent();
                _a.label = 4;
            case 4: return [4 /*yield*/, Promise.all(forms.map(function (form) { return __awaiter(void 0, void 0, void 0, function () {
                    var latestVersion;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, storage.getLatestPublishedVersion(form.id)];
                            case 1:
                                latestVersion = _a.sent();
                                return [2 /*return*/, __assign(__assign({}, form), { versionNo: (latestVersion === null || latestVersion === void 0 ? void 0 : latestVersion.versionNo) || 0, versionDate: (latestVersion === null || latestVersion === void 0 ? void 0 : latestVersion.versionDate) || null, status: (latestVersion === null || latestVersion === void 0 ? void 0 : latestVersion.status) || 'NO_VERSION' })];
                        }
                    });
                }); }))];
            case 5:
...
router.get('/admin/forms/:formId/versions', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
...
router.get('/admin/forms/:formId/versions/:versionId', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
...
router.post('/admin/forms/:formId/versions', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var formId, latestPublished, existingVersions, existingDraft, newVersion, error_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 4, , 5]);
            ...
            case 1:
                ...
                if (!latestPublished) {
                    return [2 /*return*/, res.status(404).json({ error: 'No published version found to clone' })];
                }
                return [4 /*yield*/, storage.getFormVersions(formId)];
            case 2:
                existingVersions = _a.sent();
                existingDraft = existingVersions.find(function (v) { return v.status === 'DRAFT'; });
                if (existingDraft) {
                    return [2 /*return*/, res.status(400).json({ error: 'Draft version already exists' })];
                }
                return [4 /*yield*/, storage.createFormVersion({
                        formId: formId,
...
// Update draft schema
router.put('/admin/forms/:formId/versions/:versionId/schema', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                if (!schemaJson) {
                    return [2 /*return*/, res.status(400).json({ error: 'Schema JSON is required' })];
                }
                return [4 /*yield*/, storage.updateFormVersion(versionId, {
            ...
            case 2:
                ...
                if (error_6.message === 'Can only update draft versions') {
                    return [2 /*return*/, res.status(400).json({ error: error_6.message })];
                }
                res.status(500).json({ error: 'Internal server error' });
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
...
// Publish version
router.post('/admin/forms/:formId/versions/:versionId/publish', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                if (!changelog) {
                    return [2 /*return*/, res.status(400).json({ error: 'Changelog is required' })];
                }
                return [4 /*yield*/, storage.publishFormVersion(versionId, userId || 'user', changelog)];
            case 1:
                published = _b.sent();
                res.json(published);
                return [3 /*break*/, 3];
...
// Discard draft
router.post('/admin/forms/:formId/versions/:versionId/discard', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
...
router.post('/admin/forms/:formId/versions/:versionId/rollback', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var formId, versionId, sourceVersion, existingVersions, existingDraft, latestVersion, newVersionNo, newDraft, error_9;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 4, , 5]);
            ...
            case 2:
                ...
                return [4 /*yield*/, storage.createFormVersion({
                        ...
                        status: 'DRAFT',
                        authorUserId: req.body.userId || 'user',
                        changelog: "Rollback from version ".concat(sourceVersion.versionNo),
...
router.get('/forms/runtime/:name', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                version = _a.sent();
                if (!version) {
                    return [2 /*return*/, res.status(404).json({ error: 'No published version found' })];
                }
                // Track usage
                return [4 /*yield*/, storage.createFormVersionUsage({
