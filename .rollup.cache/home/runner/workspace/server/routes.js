...
export function registerRoutes(app) {
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
            ...
            return __generator(this, function (_a) {
              switch (_a.label) {
                case 0:
                  return [
                    4 /*yield*/,
                    storage.getComponents(req.params.vesselId),
                  ];
                case 1:
                  components = _a.sent();
                  res.json(components);
      ...
      app.get('/api/running-hours/components/:vesselId', function (req, res) {
        return __awaiter(_this, void 0, void 0, function () {
      ...
      app.post('/api/running-hours/update/:componentId', function (req, res) {
        return __awaiter(_this, void 0, void 0, function () {
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                ...
                return [
                  4 /*yield*/,
                  storage.createRunningHoursAudit(updateData.audit),
                ];
              case 1:
                audit = _a.sent();
                return [
                  4 /*yield*/,
                  storage.updateComponent(componentId, {
              ...
              case 3:
                ...
                res
                  .status(500)
                  .json({ error: 'Failed to update running hours' });
                return [3 /*break*/, 4];
              case 4:
                return [2 /*return*/];
            }
      ...
      app.post('/api/running-hours/bulk-update', function (req, res) {
        return __awaiter(_this, void 0, void 0, function () {
          var updates,
            results,
            _i,
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              ...
              case 1:
                ...
                return [
                  4 /*yield*/,
                  storage.createRunningHoursAudit(update.audit),
                ];
              case 2:
                audit = _a.sent();
                return [
                  4 /*yield*/,
                  storage.updateComponent(update.componentId, {
              ...
              case 6:
                ...
                res
                  .status(500)
                  .json({ error: 'Failed to perform bulk update' });
                return [3 /*break*/, 7];
              case 7:
                return [2 /*return*/];
            }
      ...
      app.get('/api/running-hours/audits/:componentId', function (req, res) {
        return __awaiter(_this, void 0, void 0, function () {
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                ...
                return [
                  4 /*yield*/,
                  storage.getRunningHoursAudits(componentId, limit),
                ];
              case 1:
                audits = _a.sent();
                res.json(audits);
      ...
      app.post('/api/running-hours/utilization-rates', function (req, res) {
        return __awaiter(_this, void 0, void 0, function () {
          var componentIds,
            rates,
            today,
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              ...
              case 1:
                ...
                return [
                  4 /*yield*/,
                  storage.getRunningHoursAuditsInDateRange(
                    componentId,
                    thirtyDaysAgo_1,
                    today
                  ),
              ...
              case 2:
                ...
                return [
                  4 /*yield*/,
                  storage.getRunningHoursAudits(componentId),
                ];
              case 3:
                allAudits = _a.sent();
                anchorAudit = allAudits.find(function (a) {
                  return new Date(a.dateUpdatedLocal) < thirtyDaysAgo_1;
                });
                windowAudits = anchorAudit
                  ? __spreadArray([anchorAudit], audits, true)
                  : audits;
                if (windowAudits.length < 2) {
                  ...
                  deltaHours =
                    parseFloat(end.cumulativeRH) -
                    parseFloat(start.cumulativeRH);
              ...
              case 6:
                ...
                res
                  .status(500)
                  .json({ error: 'Failed to calculate utilization rates' });
                return [3 /*break*/, 7];
              case 7:
                return [2 /*return*/];
            }
      ...
      app.get('/api/spares/:vesselId', function (req, res) {
        return __awaiter(_this, void 0, void 0, function () {
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              ...
              case 1:
                spares = _a.sent();
                sparesWithStatus = spares.map(function (spare) {
                  return __assign(__assign({}, spare), {
                    stockStatus:
                      spare.rob < spare.min
                        ? 'Low'
                        : spare.rob === spare.min
      ...
      // Get single spare
      app.get('/api/spares/item/:id', function (req, res) {
        return __awaiter(_this, void 0, void 0, function () {
          var spare, error_7;
          return __generator(this, function (_a) {
            switch (_a.label) {
      ...
      // Create new spare
      app.post('/api/spares', function (req, res) {
        return __awaiter(_this, void 0, void 0, function () {
          var spare, error_8;
          return __generator(this, function (_a) {
            switch (_a.label) {
      ...
      // Update spare
      app.put('/api/spares/:id', function (req, res) {
        return __awaiter(_this, void 0, void 0, function () {
          var spare, error_9;
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                ...
                return [
                  4 /*yield*/,
                  storage.updateSpare(parseInt(req.params.id), req.body),
                ];
              case 1:
                spare = _a.sent();
                res.json(spare);
      ...
      // Delete spare
      app.delete('/api/spares/:id', function (req, res) {
        return __awaiter(_this, void 0, void 0, function () {
          var error_10;
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                ...
                return [
                  4 /*yield*/,
                  storage.deleteSpare(parseInt(req.params.id)),
                ];
              case 1:
                _a.sent();
      ...
      // Consume spare
      app.post('/api/spares/:id/consume', function (req, res) {
        return __awaiter(_this, void 0, void 0, function () {
          var _a,
            vesselId,
            qty,
          ...
          return __generator(this, function (_b) {
            switch (_b.label) {
              ...
              case 1:
                spare = _b.sent();
                spareWithStatus = __assign(__assign({}, spare), {
                  stockStatus:
                    spare.rob < spare.min
                      ? 'Low'
                      : spare.rob === spare.min
      ...
      // Receive spare
      app.post('/api/spares/:id/receive', function (req, res) {
        return __awaiter(_this, void 0, void 0, function () {
          var _a,
            vesselId,
            qty,
      ...
      // Bulk update spares
      app.post('/api/spares/bulk-update', function (req, res) {
        return __awaiter(_this, void 0, void 0, function () {
          var _a,
            vesselId,
            tz,
            ...
            switch (_b.label) {
              ...
              case 8:
                ...
                results.push({
                  ...
                  success: true,
                  robAfter:
                    (updatedSpare === null || updatedSpare === void 0
                      ? void 0
                      : updatedSpare.rob) || 0,
                });
                return [3 /*break*/, 10];
      ...
      // Get spares history
      app.get('/api/spares/history/:vesselId', function (req, res) {
        return __awaiter(_this, void 0, void 0, function () {
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                ...
                return [
                  4 /*yield*/,
                  storage.getSpareHistory(req.params.vesselId),
                ];
              case 1:
                history_1 = _a.sent();
                res.json(history_1);
      ...
      app.get('/api/spares/history/spare/:spareId', function (req, res) {
        return __awaiter(_this, void 0, void 0, function () {
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                ...
                return [
                  4 /*yield*/,
                  storage.getSpareHistoryBySpareId(
              ...
              case 2:
                ...
                res
                  .status(500)
                  .json({ error: 'Failed to fetch spare history' });
                return [3 /*break*/, 3];
              case 3:
                return [2 /*return*/];
            }
      ...
      app.get('/api/modify-pms/requests', function (req, res) {
        return __awaiter(_this, void 0, void 0, function () {
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              ...
              case 2:
                ...
                res
                  .status(500)
                  .json({ error: 'Failed to fetch change requests' });
                return [3 /*break*/, 3];
              case 3:
                return [2 /*return*/];
            }
      ...
      app.get('/api/modify-pms/requests/:id', function (req, res) {
        return __awaiter(_this, void 0, void 0, function () {
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                ...
                return [
                  4 /*yield*/,
                  storage.getChangeRequest(parseInt(req.params.id)),
                ];
              case 1:
                request = _a.sent();
                if (!request) {
                ...
                return [
                  4 /*yield*/,
                  storage.getChangeRequestAttachments(request.id),
                ];
              case 2:
                attachments = _a.sent();
                return [
                  4 /*yield*/,
                  storage.getChangeRequestComments(request.id),
                ];
              case 3:
                comments = _a.sent();
                res.json(
              ...
              case 4:
                ...
                res
                  .status(500)
                  .json({ error: 'Failed to fetch change request' });
                return [3 /*break*/, 5];
              case 5:
                return [2 /*return*/];
            }
      ...
      app.post('/api/modify-pms/requests', function (req, res) {
        return __awaiter(_this, void 0, void 0, function () {
          ...
          return __generator(this, function (_b) {
            switch (_b.label) {
              ...
              case 2:
                ...
                res
                  .status(500)
                  .json({ error: 'Failed to create change request' });
                return [3 /*break*/, 3];
              case 3:
                return [2 /*return*/];
            }
      ...
      app.put('/api/modify-pms/requests/:id', function (req, res) {
        return __awaiter(_this, void 0, void 0, function () {
          var id,
            existing,
            _a,
          ...
          return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                if (
                  ...
                  return [
                    ...
                    res
                      .status(400)
                      .json({
                        error: 'Can only edit draft or returned requests',
                      }),
                  ];
                }
                ((_a = req.body),
              ...
              case 3:
                ...
                res
                  .status(500)
                  .json({ error: 'Failed to update change request' });
                return [3 /*break*/, 4];
              case 4:
                return [2 /*return*/];
            }
      ...
      app.put('/api/modify-pms/requests/:id/target', function (req, res) {
        return __awaiter(_this, void 0, void 0, function () {
          var id,
            _a,
            targetType,
            ...
            switch (_b.label) {
              case 0:
                ...
                ((_a = req.body),
                  ...
                  (snapshotBeforeJson = _a.snapshotBeforeJson));
                return [
                  4 /*yield*/,
                  storage.updateChangeRequestTarget(
                    id,
                    targetType,
                    targetId,
                    snapshotBeforeJson
              ...
              case 2:
                ...
                res
                  .status(500)
                  .json({
                    error: error_21.message || 'Failed to update target',
                  });
                return [3 /*break*/, 3];
              case 3:
                return [2 /*return*/];
      ...
      app.put('/api/modify-pms/requests/:id/proposed', function (req, res) {
        return __awaiter(_this, void 0, void 0, function () {
          ...
          return __generator(this, function (_b) {
            switch (_b.label) {
              case 0:
                ...
                id = parseInt(req.params.id);
                ((_a = req.body),
                  (proposedChangesJson = _a.proposedChangesJson),
                  (movePreviewJson = _a.movePreviewJson));
                return [
                  4 /*yield*/,
                  storage.updateChangeRequestProposed(
                    id,
                    proposedChangesJson,
                    movePreviewJson
                  ),
              ...
              case 2:
                ...
                res
                  ...
                  .json({
                    error:
                      error_22.message || 'Failed to update proposed changes',
                  });
                return [3 /*break*/, 3];
              case 3:
                return [2 /*return*/];
      ...
      app.put('/api/modify-pms/requests/:id/submit', function (req, res) {
        return __awaiter(_this, void 0, void 0, function () {
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              ...
              case 1:
                ...
                if (
                  ...
                  return [
                    ...
                    res
                      .status(400)
                      .json({
                        error: 'Can only submit draft or returned requests',
                      }),
                  ];
                }
                ...
                if (
                  ...
                  return [
                    ...
                    res.status(400).json({
                      error:
                        'Please propose at least one change before submitting',
                    }),
                  ];
                }
                return [
                  4 /*yield*/,
                  storage.submitChangeRequest(
                    id,
              ...
              case 3:
                ...
                res
                  .status(500)
                  .json({ error: 'Failed to submit change request' });
                return [3 /*break*/, 4];
              case 4:
                return [2 /*return*/];
            }
      ...
      app.put('/api/modify-pms/requests/:id/approve', function (req, res) {
        return __awaiter(_this, void 0, void 0, function () {
            ...
            switch (_b.label) {
              ...
              case 2:
                ...
                res
                  ...
                  .json({
                    error:
                      error_24.message || 'Failed to approve change request',
                  });
                return [3 /*break*/, 3];
              case 3:
                return [2 /*return*/];
      ...
      app.put('/api/modify-pms/requests/:id/reject', function (req, res) {
        return __awaiter(_this, void 0, void 0, function () {
            ...
            switch (_b.label) {
              ...
              case 2:
                ...
                res
                  ...
                  .json({
                    error:
                      error_25.message || 'Failed to reject change request',
                  });
                return [3 /*break*/, 3];
              case 3:
                return [2 /*return*/];
      ...
      app.put('/api/modify-pms/requests/:id/return', function (req, res) {
        return __awaiter(_this, void 0, void 0, function () {
            ...
            switch (_b.label) {
              ...
              case 2:
                ...
                res
                  ...
                  .json({
                    error:
                      error_26.message || 'Failed to return change request',
                  });
                return [3 /*break*/, 3];
              case 3:
                return [2 /*return*/];
      ...
      app.delete('/api/modify-pms/requests/:id', function (req, res) {
        return __awaiter(_this, void 0, void 0, function () {
          var id, error_27;
          return __generator(this, function (_a) {
            switch (_a.label) {
              ...
              case 2:
                ...
                res
                  ...
                  .json({
                    error:
                      error_27.message || 'Failed to delete change request',
                  });
                return [3 /*break*/, 3];
              case 3:
                return [2 /*return*/];
      ...
      // Create attachment
      app.post('/api/modify-pms/requests/:id/attachments', function (req, res) {
        return __awaiter(_this, void 0, void 0, function () {
          var changeRequestId,
            _a,
            filename,
            ...
            switch (_b.label) {
              case 0:
                ...
                ((_a = req.body),
                  ...
                  (url = _a.url),
                  (uploadedByUserId = _a.uploadedByUserId));
                if (!filename || !url) {
                  return [
                    2 /*return*/,
                    res
                      .status(400)
                      .json({ error: 'Filename and URL are required' }),
                  ];
                }
                return [
                  4 /*yield*/,
                  storage.createChangeRequestAttachment({
      ...
      // Create comment
      app.post('/api/modify-pms/requests/:id/comments', function (req, res) {
        return __awaiter(_this, void 0, void 0, function () {
          ...
          return __generator(this, function (_b) {
            switch (_b.label) {
              case 0:
                ...
                return [
                  4 /*yield*/,
                  storage.createChangeRequestComment({
                    changeRequestId: changeRequestId,
