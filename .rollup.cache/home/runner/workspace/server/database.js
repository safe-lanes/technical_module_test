...
import { users, forms, rankGroups, availableRanks, crewMembers, appraisalResults } from "@shared/schema";
...
var DatabaseStorage = /** @class */ (function () {
    ...
    DatabaseStorage.prototype.getUserByUsername = function (username) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.db.select().from(users).where(eq(users.username, username))];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, result[0]];
                }
    ...
    DatabaseStorage.prototype.createUser = function (insertUser) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.db.insert(users).values(insertUser).returning()];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, result[0]];
                }
    ...
    DatabaseStorage.prototype.getForms = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.db.select().from(forms)];
    ...
    DatabaseStorage.prototype.getForm = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.db.select().from(forms).where(eq(forms.id, id))];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, result[0]];
                }
    ...
    DatabaseStorage.prototype.createForm = function (insertForm) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.db.insert(forms).values(insertForm).returning()];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, result[0]];
                }
    ...
    DatabaseStorage.prototype.updateForm = function (id, formData) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.db.update(forms).set(formData).where(eq(forms.id, id)).returning()];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, result[0]];
                }
    ...
    DatabaseStorage.prototype.deleteForm = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.db.delete(forms).where(eq(forms.id, id))];
                    case 1:
                        result = _a.sent();
    ...
    DatabaseStorage.prototype.getRankGroups = function (formId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.db.select().from(rankGroups).where(eq(rankGroups.formId, formId))];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    DatabaseStorage.prototype.createRankGroup = function (insertRankGroup) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.db.insert(rankGroups).values(insertRankGroup).returning()];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, result[0]];
                }
    ...
    DatabaseStorage.prototype.updateRankGroup = function (id, rankGroupData) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.db.update(rankGroups).set(rankGroupData).where(eq(rankGroups.id, id)).returning()];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, result[0]];
                }
    ...
    DatabaseStorage.prototype.deleteRankGroup = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.db.delete(rankGroups).where(eq(rankGroups.id, id))];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, result.affectedRows > 0];
                }
    ...
    DatabaseStorage.prototype.getAvailableRanks = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.db.select().from(availableRanks)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    DatabaseStorage.prototype.createAvailableRank = function (insertAvailableRank) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.db.insert(availableRanks).values(insertAvailableRank).returning()];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, result[0]];
                }
    ...
    DatabaseStorage.prototype.getCrewMembers = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.db.select().from(crewMembers)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    DatabaseStorage.prototype.getCrewMember = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.db.select().from(crewMembers).where(eq(crewMembers.id, id))];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, result[0]];
                }
    ...
    DatabaseStorage.prototype.createCrewMember = function (insertCrewMember) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.db.insert(crewMembers).values(insertCrewMember).returning()];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, result[0]];
                }
    ...
    DatabaseStorage.prototype.updateCrewMember = function (id, crewMemberData) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.db.update(crewMembers).set(crewMemberData).where(eq(crewMembers.id, id)).returning()];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, result[0]];
                }
    ...
    DatabaseStorage.prototype.deleteCrewMember = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.db.delete(crewMembers).where(eq(crewMembers.id, id))];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, result.affectedRows > 0];
                }
    ...
    DatabaseStorage.prototype.getAppraisalResults = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.db.select().from(appraisalResults)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    DatabaseStorage.prototype.getAppraisalResult = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.db.select().from(appraisalResults).where(eq(appraisalResults.id, id))];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, result[0]];
                }
    ...
    DatabaseStorage.prototype.getAppraisalResultsByCrewMember = function (crewMemberId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.db.select().from(appraisalResults).where(eq(appraisalResults.crewMemberId, crewMemberId))];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    DatabaseStorage.prototype.createAppraisalResult = function (insertAppraisalResult) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.db.insert(appraisalResults).values(insertAppraisalResult).returning()];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, result[0]];
                }
    ...
    DatabaseStorage.prototype.updateAppraisalResult = function (id, appraisalResultData) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.db.update(appraisalResults).set(appraisalResultData).where(eq(appraisalResults.id, id)).returning()];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, result[0]];
                }
    ...
    DatabaseStorage.prototype.deleteAppraisalResult = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.db.delete(appraisalResults).where(eq(appraisalResults.id, id))];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, result.affectedRows > 0];
                }
    ...
    DatabaseStorage.prototype.seedDatabase = function () {
        return __awaiter(this, void 0, void 0, function () {
            var existingForms, rankData, _i, rankData_1, rank, form, crewMemberData, _a, crewMemberData_1, crewMember, appraisalData, _b, appraisalData_1, appraisal, error_3;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 4:
                        _i++;
                        return [3 /*break*/, 2];
                    case 5: return [4 /*yield*/, this.createForm({
                    ...
                    case 6:
                        form = _c.sent();
                        // Seed rank groups
                        return [4 /*yield*/, this.createRankGroup({
                                formId: form.id,
