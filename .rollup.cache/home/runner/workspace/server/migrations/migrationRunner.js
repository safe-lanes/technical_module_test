        ...
        switch (_a.label) {
          ...
          case 1:
            ...
            migrations = migrationFiles
              .filter(function (file) {
                return file.startsWith('migration_') && file.endsWith('.ts');
              })
              .sort();
          ...
          case 5:
            ...
            console.log(
              '\u2713 Migration '
                .concat(migration.id, ' (')
                .concat(migration.name, ') completed')
            );
            return [3 /*break*/, 7];
          case 6:
            error_1 = _a.sent();
            console.error(
              '\u2717 Migration '.concat(migration.id, ' failed:'),
              error_1
            );
            throw error_1;
          case 7:
        ...
        switch (_a.label) {
          ...
          case 4:
            ...
            console.log(
              '\u2713 Migration '
                .concat(migration.id, ' (')
                .concat(migration.name, ') rolled back')
            );
            return [3 /*break*/, 6];
          case 5:
            error_2 = _a.sent();
            console.error(
              '\u2717 Migration rollback '.concat(migration.id, ' failed:'),
              error_2
            );
            throw error_2;
          case 6:
