...
export var runningHoursAudit = pgTable("running_hours_audit", {
    id: integer("id").primaryKey().generatedByDefaultAsIdentity(),
...
// Form Versions Table
export var formVersions = pgTable("form_versions", {
    id: integer("id").primaryKey().generatedByDefaultAsIdentity(),
...
// Spares Table
export var spares = pgTable("spares", {
    id: integer("id").primaryKey().generatedByDefaultAsIdentity(),
...
export var sparesHistory = pgTable("spares_history", {
    id: integer("id").primaryKey().generatedByDefaultAsIdentity(),
...
export var storesLedger = pgTable("stores_ledger", {
    id: integer("id").primaryKey().generatedByDefaultAsIdentity(),
    vesselId: text("vessel_id").notNull(),
...
export var changeRequest = pgTable("change_request", {
    id: integer("id").primaryKey().generatedByDefaultAsIdentity(),
    vesselId: text("vessel_id").notNull(),
    ...
    updatedAt: timestamp("updated_at").notNull().defaultNow().$onUpdateFn(function () { return new Date(); }),
}, function (table) { return ({
...
export var changeRequestAttachment = pgTable("change_request_attachment", {
    id: integer("id").primaryKey().generatedByDefaultAsIdentity(),
...
export var changeRequestComment = pgTable("change_request_comment", {
    id: integer("id").primaryKey().generatedByDefaultAsIdentity(),
    changeRequestId: integer("change_request_id").notNull(),
    userId: text("user_id").notNull(),
...
// Alert Events Table
export var alertEvents = pgTable("alert_events", {
    id: integer("id").primaryKey().generatedByDefaultAsIdentity(),
...
export var alertDeliveries = pgTable("alert_deliveries", {
    id: integer("id").primaryKey().generatedByDefaultAsIdentity(),
