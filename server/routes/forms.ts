...
// Update draft schema
router.put('/admin/forms/:formId/versions/:versionId/schema', async (req, res) => {
  try {
    const versionId = parseInt(req.params.versionId);
...
// Publish version
router.post('/admin/forms/:formId/versions/:versionId/publish', async (req, res) => {
  try {
    const versionId = parseInt(req.params.versionId);
...
// Discard draft
router.post('/admin/forms/:formId/versions/:versionId/discard', async (req, res) => {
  try {
    const versionId = parseInt(req.params.versionId);
...
router.post('/admin/forms/:formId/versions/:versionId/rollback', async (req, res) => {
  try {
    const formId = parseInt(req.params.formId);
    const versionId = parseInt(req.params.versionId);
